...
```typescript
import { InvokeDeploymentRequest24 } from "@orq-ai/node/models/components";

let value: InvokeDeploymentRequest24 = {
  type: "file",
  file: {},
};
```
...
| `cacheControl`                                                                                                     | [components.InvokeDeploymentRequest2CacheControl](../../models/components/invokedeploymentrequest2cachecontrol.md) | :heavy_minus_sign:                                                                                                 | N/A                                                                                                                |
