...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `displayName`                                                           | *string*                                                                | :heavy_check_mark:                                                      | Workspace-unique display name.                                          | High spend on production                                                |
...
| `display`                                                               | [components.AlertDisplay](../../models/components/alertdisplay.md)      | :heavy_minus_sign:                                                      | Display options for the alert activity chart.                           |                                                                         |