...
```typescript
import { ResponseFailedStreamEvent } from "@orq-ai/node/models/components";

let value: ResponseFailedStreamEvent = {
  response: {
    background: true,
    completedAt: 943245,
    createdAt: 963158,
...
| `type`                                                                                 | *"response.failed"*                                                                    | :heavy_check_mark:                                                                     | The event type. Discriminates the payload.                                             |
