...
```typescript
import { ResponseCreatedStreamEvent } from "@orq-ai/node/models/components";

let value: ResponseCreatedStreamEvent = {
  response: {
    background: true,
    completedAt: 943245,
    createdAt: 963158,
...
| `type`                                                                                 | *"response.created"*                                                                   | :heavy_check_mark:                                                                     | The event type. Discriminates the payload.                                             |
