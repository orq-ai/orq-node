...
```typescript
import { Guardrails } from "@orq-ai/node/models/components";
...
| `executeOn`                                                                                                                                                            | [components.AgentStartedStreamingEventExecuteOn](../../models/components/agentstartedstreamingeventexecuteon.md)                                                       | :heavy_check_mark:                                                                                                                                                     | Determines whether the evaluator runs on the agent input (user message) or output (agent response).                                                                    |