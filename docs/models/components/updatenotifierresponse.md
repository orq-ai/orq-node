...
```typescript
import { UpdateNotifierResponse } from "@orq-ai/node/models/components";

let value: UpdateNotifierResponse = {
  notifier: {
    type: "NOTIFIER_TYPE_SLACK_WEBHOOK",
    incomingWebhookUrl: "https://extroverted-roadway.net/",
    id: "<id>",
    displayName: "Jay_Von-Shanahan",
