...
```typescript
import { AgentThoughtStreamingEventCompletionTokensDetails } from "@orq-ai/node/models/components";

let value: AgentThoughtStreamingEventCompletionTokensDetails = {};
```
