...
```typescript
import { ResponseReasoningTextDeltaStreamEvent } from "@orq-ai/node/models/components";

let value: ResponseReasoningTextDeltaStreamEvent = {
  contentIndex: 796218,
  delta: "<value>",
  itemId: "<id>",
  outputIndex: 520826,
...
| `type`                                                        | *"response.reasoning_text.delta"*                             | :heavy_check_mark:                                            | The event type. Discriminates the payload.                    |
