...
```typescript
import { AddAnnotationQueueItemsResponseBody } from "@orq-ai/node/models/operations";

let value: AddAnnotationQueueItemsResponseBody = {
  id: "<id>",
...
| `type`                                                                                           | [operations.AddAnnotationQueueItemsType](../../models/operations/addannotationqueueitemstype.md) | :heavy_check_mark:                                                                               | N/A                                                                                              |