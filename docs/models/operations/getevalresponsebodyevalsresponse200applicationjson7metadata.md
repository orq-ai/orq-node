...
```typescript
import { GetEvalResponseBodyEvalsResponse200ApplicationJson7Metadata } from "@orq-ai/node/models/operations";

let value: GetEvalResponseBodyEvalsResponse200ApplicationJson7Metadata = {};
```
...
| `supportUseAsGuardrail`         | *boolean*                       | :heavy_minus_sign:              | N/A                             |