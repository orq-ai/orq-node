...
```typescript
import { StreamAgentA2AInvokeRequest } from "@orq-ai/node/models/operations";

let value: StreamAgentA2AInvokeRequest = {
  message: {
    role: "tool",
    parts: [
      {
...
| `engine`                                                                                                                                                                                                     | [operations.StreamAgentEngine](../../models/operations/streamagentengine.md)                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                                                           | Override template engine for this invocation. If not provided, uses the agent default.                                                                                                                       |
| `configuration`                                                                                                                                                                                              | [operations.StreamAgentConfiguration](../../models/operations/streamagentconfiguration.md)                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                           | Configuration options for the agent invocation                                                                                                                                                               |
