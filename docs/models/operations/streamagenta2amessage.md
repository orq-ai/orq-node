...
| `parts`                                                                                                            | *operations.StreamAgentPublicMessagePart*[]                                                                        | :heavy_check_mark:                                                                                                 | A2A message parts (text, file, or tool_result only). Note: Tool role messages must only contain tool_result parts. |