...
```typescript
import { CreateAgentRequestFallbackModelConfigurationRetry } from "@orq-ai/node/models/operations";

let value: CreateAgentRequestFallbackModelConfigurationRetry = {
  onCodes: [
    429,
    500,
    502,
