...
```typescript
import { CreateAgentRequestFallbackModelConfigurationAgentsResponseRetry } from "@orq-ai/node/models/operations";

let value: CreateAgentRequestFallbackModelConfigurationAgentsResponseRetry = {
  onCodes: [
    429,
    500,
    502,
