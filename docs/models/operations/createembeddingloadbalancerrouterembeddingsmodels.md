...
```typescript
import { CreateEmbeddingLoadBalancerRouterEmbeddingsModels } from "@orq-ai/node/models/operations";

let value: CreateEmbeddingLoadBalancerRouterEmbeddingsModels = {
  model: "openai/gpt-4o",
  weight: 0.7,
};
```
