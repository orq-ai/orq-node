...
```typescript
import { Evaluators } from "@orq-ai/node/models/operations";
...
| `executeOn`                                                                                                                                                            | [operations.ExecuteOn](../../models/operations/executeon.md)                                                                                                           | :heavy_check_mark:                                                                                                                                                     | Determines whether the evaluator runs on the agent input (user message) or output (agent response).                                                                    |