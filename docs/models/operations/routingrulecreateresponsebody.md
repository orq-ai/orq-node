...
```typescript
import { RoutingRuleCreateResponseBody } from "@orq-ai/node/models/operations";

let value: RoutingRuleCreateResponseBody = {
  id: "<id>",
  createdAt: new Date("2025-01-22T19:31:19.147Z"),
  createdById: "<id>",
  displayName: "Billy17",
  enabled: false,
  priority: 314669,
  projectId: "<id>",
  updatedAt: new Date("2025-08-15T17:10:07.989Z"),
  updatedById: "<id>",
};
```
