...
```typescript
import { CreateCompletionLoadBalancerRouterCompletionsModels } from "@orq-ai/node/models/operations";

let value: CreateCompletionLoadBalancerRouterCompletionsModels = {
  model: "openai/gpt-4o",
  weight: 0.7,
};
```
