...
```typescript
import { GetOnePrompt24 } from "@orq-ai/node/models/operations";

let value: GetOnePrompt24 = {
  type: "file",
  file: {},
};
```
...
| `cacheControl`                                                                               | [operations.GetOnePrompt2CacheControl](../../models/operations/getoneprompt2cachecontrol.md) | :heavy_minus_sign:                                                                           | N/A                                                                                          |
