...
```typescript
import { CreateChatCompletionLoadBalancerRouterChatCompletionsModels } from "@orq-ai/node/models/operations";

let value: CreateChatCompletionLoadBalancerRouterChatCompletionsModels = {
  model: "openai/gpt-4o",
  weight: 0.7,
};
```
