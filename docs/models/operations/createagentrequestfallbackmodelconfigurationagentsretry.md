...
```typescript
import { CreateAgentRequestFallbackModelConfigurationAgentsRetry } from "@orq-ai/node/models/operations";

let value: CreateAgentRequestFallbackModelConfigurationAgentsRetry = {
  onCodes: [
    429,
    500,
    502,
