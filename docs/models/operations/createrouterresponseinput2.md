...
| `async`                                                                            | *boolean*                                                                          | :heavy_minus_sign:                                                                 | Whether a function or custom tool call runs asynchronously.                        |
...
| `reasoning`                                                                        | [operations.Reasoning](../../models/operations/reasoning.md)                       | :heavy_minus_sign:                                                                 | Reasoning settings applied by a configuration_update item.                         |
...
| `status`                                                                           | [operations.Status](../../models/operations/status.md)                             | :heavy_minus_sign:                                                                 | The status of a model-generated input item.                                        |
