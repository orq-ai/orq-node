...
```typescript
import { RetrieveAnnotationQueueItemOutputAnnotationQueues1 } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemOutputAnnotationQueues1 = {
  id: "<id>",
  type: "message",
  role: "assistant",
  status: "failed",
