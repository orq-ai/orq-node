...
```typescript
import { RetrieveAnnotationQueueItemResponseBodyRerankConfig } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemResponseBodyRerankConfig = {
