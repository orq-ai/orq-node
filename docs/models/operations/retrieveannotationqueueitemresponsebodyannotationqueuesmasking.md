...
```typescript
import { RetrieveAnnotationQueueItemResponseBodyAnnotationQueuesMasking } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemResponseBodyAnnotationQueuesMasking = {};
```
