...
```typescript
import { StreamRunAgentFileAgentsFileInURIFormat } from "@orq-ai/node/models/operations";

let value: StreamRunAgentFileAgentsFileInURIFormat = {
  uri: "https://entire-gastropod.org/",
};
```
