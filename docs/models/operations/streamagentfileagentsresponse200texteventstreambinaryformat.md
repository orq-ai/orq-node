...
```typescript
import { StreamAgentFileAgentsResponse200TextEventStreamBinaryFormat } from "@orq-ai/node/models/operations";

let value: StreamAgentFileAgentsResponse200TextEventStreamBinaryFormat = {
  bytes: "<value>",
};
```
