...
```typescript
import { DeploymentGetConfig24 } from "@orq-ai/node/models/operations";

let value: DeploymentGetConfig24 = {
  type: "file",
  file: {},
};
```
...
| `cacheControl`                                                                                             | [operations.DeploymentGetConfig2CacheControl](../../models/operations/deploymentgetconfig2cachecontrol.md) | :heavy_minus_sign:                                                                                         | N/A                                                                                                        |
