...
```typescript
import { StreamRunAgentFileAgentsResponse200TextEventStreamBinaryFormat } from "@orq-ai/node/models/operations";

let value: StreamRunAgentFileAgentsResponse200TextEventStreamBinaryFormat = {
  bytes: "<value>",
};
```
