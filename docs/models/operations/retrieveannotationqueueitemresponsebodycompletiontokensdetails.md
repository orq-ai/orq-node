...
```typescript
import { RetrieveAnnotationQueueItemResponseBodyCompletionTokensDetails } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemResponseBodyCompletionTokensDetails = {};
```
