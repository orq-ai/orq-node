...
```typescript
import { RetrieveAnnotationQueueItemResultsAnnotationQueuesCategories } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemResultsAnnotationQueuesCategories = {
  sexual: true,
