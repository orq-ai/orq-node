...
```typescript
import { RetrieveAgentRequestFallbackModelConfigurationAgentsRetry } from "@orq-ai/node/models/operations";

let value: RetrieveAgentRequestFallbackModelConfigurationAgentsRetry = {
  onCodes: [
    429,
    500,
    502,
