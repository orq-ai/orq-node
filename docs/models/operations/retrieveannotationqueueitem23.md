...
```typescript
import { RetrieveAnnotationQueueItem23 } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItem23 = {
  type: "function_call",
  callId: "<id>",
  id: "<id>",
  name: "<value>",
...
| ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `type`                                                                                                                                     | [operations.RetrieveAnnotationQueueItem2AnnotationQueuesType](../../models/operations/retrieveannotationqueueitem2annotationqueuestype.md) | :heavy_check_mark:                                                                                                                         | The type of input item                                                                                                                     |
