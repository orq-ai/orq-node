...
```typescript
import { CreateImageLoadBalancerRouterImagesGenerationsModels } from "@orq-ai/node/models/operations";

let value: CreateImageLoadBalancerRouterImagesGenerationsModels = {
  model: "openai/gpt-4o",
  weight: 0.7,
};
```
