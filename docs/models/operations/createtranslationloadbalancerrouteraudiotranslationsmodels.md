...
```typescript
import { CreateTranslationLoadBalancerRouterAudioTranslationsModels } from "@orq-ai/node/models/operations";

let value: CreateTranslationLoadBalancerRouterAudioTranslationsModels = {
  model: "openai/gpt-4o",
  weight: 0.7,
};
```
