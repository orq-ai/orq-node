...
| `configuration`                                                                                                                                                                                              | [operations.InvokeAgentConfiguration](../../models/operations/invokeagentconfiguration.md)                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                           | Configuration options for the agent invocation                                                                                                                                                               |