...
* [listCapabilities](#listcapabilities) - List capability catalog
...
<!-- UsageSnippet language="typescript" operationID="ApiKeyList" method="get" path="/v2/api-keys" -->
```typescript
...
import { apiKeysList } from "@orq-ai/node/funcs/apiKeysList.js";
...
async function run() {
  const res = await apiKeysList(orq);
  if (res.ok) {
...
<!-- UsageSnippet language="typescript" operationID="ApiKeyCreate" method="post" path="/v2/api-keys" -->
```typescript
import { Orq } from "@orq-ai/node";
...
```typescript
import { OrqCore } from "@orq-ai/node/core.js";
import { apiKeysCreate } from "@orq-ai/node/funcs/apiKeysCreate.js";
...
<!-- UsageSnippet language="typescript" operationID="ApiKeyListCapabilities" method="get" path="/v2/api-keys/capabilities" -->
```typescript
import { Orq } from "@orq-ai/node";
...
```typescript
import { OrqCore } from "@orq-ai/node/core.js";
import { apiKeysListCapabilities } from "@orq-ai/node/funcs/apiKeysListCapabilities.js";
...
async function run() {
  const res = await apiKeysListCapabilities(orq);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("apiKeysListCapabilities failed:", res.error);
  }
}
...
**Promise\<[components.ListCapabilitiesResponse](../../models/components/listcapabilitiesresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="ApiKeyGet" method="get" path="/v2/api-keys/{api_key_id}" -->
```typescript
import { Orq } from "@orq-ai/node";
...
```typescript
import { OrqCore } from "@orq-ai/node/core.js";
import { apiKeysGet } from "@orq-ai/node/funcs/apiKeysGet.js";
...
async function run() {
  const res = await apiKeysGet(orq, {
    apiKeyId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.ApiKeyGetRequest](../../models/operations/apikeygetrequest.md)                                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="ApiKeyDelete" method="delete" path="/v2/api-keys/{api_key_id}" -->
```typescript
import { Orq } from "@orq-ai/node";
...
```typescript
import { OrqCore } from "@orq-ai/node/core.js";
import { apiKeysDelete } from "@orq-ai/node/funcs/apiKeysDelete.js";
...
async function run() {
  const res = await apiKeysDelete(orq, {
    apiKeyId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
<!-- UsageSnippet language="typescript" operationID="ApiKeyUpdate" method="patch" path="/v2/api-keys/{api_key_id}" -->
```typescript
import { Orq } from "@orq-ai/node";
...
```typescript
import { OrqCore } from "@orq-ai/node/core.js";
import { apiKeysUpdate } from "@orq-ai/node/funcs/apiKeysUpdate.js";
...
async function run() {
  const res = await apiKeysUpdate(orq, {
    apiKeyId: "<id>",
    updateApiKeyRequest: {},
  });
  if (res.ok) {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.ApiKeyUpdateRequest](../../models/operations/apikeyupdaterequest.md)                                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
