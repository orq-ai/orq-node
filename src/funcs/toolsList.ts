...
export function toolsList(
  ...
  Result<
    operations.GetAllToolsResponseBody,
    | errors.HonoApiError
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllToolsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllToolsResponseBody$inboundSchema),
