...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ModelEnableRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/workspace-models")();
