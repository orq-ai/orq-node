...
export function monitorsList(
  ...
  Result<
    components.ListMonitorsResponse,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MonitorListRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListMonitorsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
