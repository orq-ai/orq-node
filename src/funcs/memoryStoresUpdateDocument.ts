 ...
 */
export function memoryStoresUpdateDocument(
  client: OrqCore,
  request: operations.UpdateMemoryDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateMemoryDocumentResponseBody,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateMemoryDocumentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateMemoryDocumentResponseBody$inboundSchema),
