 ...
 */
export function modelsCreateAwsBedrock(
  client: OrqCore,
  request: operations.ModelCreateAwsBedrockRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ModelCreateAwsBedrockResponseBody,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ModelCreateAwsBedrockRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/models/aws-bedrock")();
  ...
  const context = {
    ...
    operationID: "ModelCreateAwsBedrock",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ModelCreateAwsBedrockResponseBody$inboundSchema),
