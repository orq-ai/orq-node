 ...
 */
export function modelsValidateAwsBedrock(
  client: OrqCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ModelValidateAwsBedrockRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/models/aws-bedrock/validate")();
  ...
  const context = {
    ...
    operationID: "ModelValidateAwsBedrock",
    oAuth2Scopes: null,
