...
export function routerAudioTranslationsCreate(
  ...
  Result<
    ...
    | errors.CreateTranslationResponseBody
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateTranslationRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/router/audio/translations")();
  ...
  >(
    ...
    M.jsonErr(422, errors.CreateTranslationResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
