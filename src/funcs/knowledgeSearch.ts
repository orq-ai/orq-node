...
export function knowledgeSearch(
  ...
  Result<
    components.SearchKnowledgeResponse,
    | OrqError
...
> {
  ...
  const body = encodeJSON("body", payload.SearchKnowledgeRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SearchKnowledgeResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
