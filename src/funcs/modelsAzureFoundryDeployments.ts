 ...
 */
export function modelsAzureFoundryDeployments(
  client: OrqCore,
  request: operations.ModelAzureFoundryDeploymentsRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ModelAzureFoundryDeploymentsResponseBody,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ModelAzureFoundryDeploymentsRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/models/azure-foundry/deployments")();
