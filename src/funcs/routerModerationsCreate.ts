...
export function routerModerationsCreate(
  ...
  Result<
    operations.CreateModerationResponseBody,
    | errors.CreateModerationResponseBody
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateModerationRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/router/moderations")();
