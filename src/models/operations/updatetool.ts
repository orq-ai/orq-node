...
export const UpdateToolRequestBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5QVFSKZER3483FDA3Y"),
  path: z.string().optional(),
...
export const UpdateToolRequestBody3$outboundSchema: z.ZodType<
  ...
  UpdateToolRequestBody3
> = z.object({
  id: z.string().default("01K6MG8W5QVFSKZER3483FDA3Y"),
  path: z.string().optional(),
...
export const UpdateToolRequestBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5QG6AVTGW45C32500Y"),
  path: z.string().optional(),
  display_name: z.string().optional(),
  description: z.string().optional(),
...
export const UpdateToolRequestBody2$outboundSchema: z.ZodType<
  ...
  UpdateToolRequestBody2
> = z.object({
  id: z.string().default("01K6MG8W5QG6AVTGW45C32500Y"),
  path: z.string().optional(),
  displayName: z.string().optional(),
  description: z.string().optional(),
...
export const UpdateToolResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5P88QFGRH4G1WR5JCN"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody5$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody5
> = z.object({
  id: z.string().default("01K6MG8W5P88QFGRH4G1WR5JCN"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5PHAXM5PK3KNBRV2XA"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody4$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody4
> = z.object({
  id: z.string().default("01K6MG8W5PHAXM5PK3KNBRV2XA"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5NN04F04P1535T8E7H"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody3
> = z.object({
  id: z.string().default("01K6MG8W5NN04F04P1535T8E7H"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5MTZX081PZ675118D7"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody2
> = z.object({
  id: z.string().default("01K6MG8W5MTZX081PZ675118D7"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K6MG8W5M1K8E35RDRGSNBG1A"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody1
> = z.object({
  id: z.string().default("01K6MG8W5M1K8E35RDRGSNBG1A"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
