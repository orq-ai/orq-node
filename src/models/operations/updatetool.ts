...
export const RequestBodyTools$outboundSchema: z.ZodType<
  ...
  RequestBodyTools
> = z.object({
  id: z.string().default("01KP5JTBD732YXSJQ34GEF971C"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KP5JTBCTBMV1APPWZ51REDF6"),
  path: z.string(),
  key: z.string(),
...
export const UpdateToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KP5JTBCSFGRFB1BRX9GECP3C"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KP5JTBCRZ55WA8Y33464SH44"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KP5JTBCPDJ7B6WFGX2CRAP4A"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KP5JTBCM1JHBKJGFY8DTGE65"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KP5JTBCK0PZ89GXKYMZRCDD1"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
