...
export const UpdateToolResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K9WC7SBTS4PRQPX616C4TV9E"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody5$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody5
> = z.object({
  id: z.string().default("01K9WC7SBTS4PRQPX616C4TV9E"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K9WC7SBRE3DPQA2S0JZ4FN31"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody4$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody4
> = z.object({
  id: z.string().default("01K9WC7SBRE3DPQA2S0JZ4FN31"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K9WC7SBPYM25R19VMFX92EEX"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody3
> = z.object({
  id: z.string().default("01K9WC7SBPYM25R19VMFX92EEX"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K9WC7SBMVY544JTGNMNCS81F"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody2
> = z.object({
  id: z.string().default("01K9WC7SBMVY544JTGNMNCS81F"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K9WC7SBK0Y5AMB1MP6VEHWFV"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody1
> = z.object({
  id: z.string().default("01K9WC7SBK0Y5AMB1MP6VEHWFV"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
