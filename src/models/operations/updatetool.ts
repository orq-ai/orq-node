...
export const UpdateToolResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA4HR4VN4W2PCM714MBYW39X"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody5$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody5
> = z.object({
  id: z.string().default("01KA4HR4VN4W2PCM714MBYW39X"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA4HR4VKVZ0YDTWJR9VSAPRC"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody4$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody4
> = z.object({
  id: z.string().default("01KA4HR4VKVZ0YDTWJR9VSAPRC"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA4HR4VGMBNPZKVKZ9BKSN5K"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody3
> = z.object({
  id: z.string().default("01KA4HR4VGMBNPZKVKZ9BKSN5K"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA4HR4VDQ26G134R80WDG9M6"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody2
> = z.object({
  id: z.string().default("01KA4HR4VDQ26G134R80WDG9M6"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA4HR4VBR798RX92CQVZ81PK"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody1
> = z.object({
  id: z.string().default("01KA4HR4VBR798RX92CQVZ81PK"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
