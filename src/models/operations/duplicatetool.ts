...
export const DuplicateToolResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA0VD61D6V51B3MDW3YP2KZD"),
  path: z.string(),
  key: z.string(),
...
export const DuplicateToolResponseBody5$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody5
> = z.object({
  id: z.string().default("01KA0VD61D6V51B3MDW3YP2KZD"),
  path: z.string(),
  key: z.string(),
...
export const DuplicateToolResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA0VD61B1GADZW21RHSG3ZE5"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody4$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody4
> = z.object({
  id: z.string().default("01KA0VD61B1GADZW21RHSG3ZE5"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA0VD619CTG8T6DDYYK0E24E"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody3
> = z.object({
  id: z.string().default("01KA0VD619CTG8T6DDYYK0E24E"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA0VD6182777EYR568HNAE7C"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody2
> = z.object({
  id: z.string().default("01KA0VD6182777EYR568HNAE7C"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01KA0VD617J38ZCQJJNNXK5KN9"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody1
> = z.object({
  id: z.string().default("01KA0VD617J38ZCQJJNNXK5KN9"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
