...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-05T17:21:36.351Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-05T17:21:36.350Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-05T17:21:36.349Z"))
    .transform(v => v.toISOString()),
