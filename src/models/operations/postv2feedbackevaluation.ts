...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-11T10:07:27.334Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-11T10:07:27.333Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-11T10:07:27.332Z"))
    .transform(v => v.toISOString()),
