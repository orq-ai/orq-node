...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-14T10:31:04.320Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-14T10:31:04.319Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-14T10:31:04.318Z"))
    .transform(v => v.toISOString()),
