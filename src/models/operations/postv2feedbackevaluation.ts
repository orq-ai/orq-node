...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-09-01T07:51:16.252Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-09-01T07:51:16.248Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-09-01T07:51:16.247Z"))
    .transform(v => v.toISOString()),
