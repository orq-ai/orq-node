...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-05T22:04:29.333Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-05T22:04:29.332Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-05T22:04:29.331Z"))
    .transform(v => v.toISOString()),
