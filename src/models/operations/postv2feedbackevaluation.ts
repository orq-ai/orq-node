...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-17T10:34:18.775Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-17T10:34:18.774Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-17T10:34:18.773Z"))
    .transform(v => v.toISOString()),
