...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-25T20:22:00.608Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T20:22:00.607Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T20:22:00.606Z"))
    .transform(v => v.toISOString()),
