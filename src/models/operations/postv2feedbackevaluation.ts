...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-10T10:36:46.992Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-10T10:36:46.991Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-10T10:36:46.990Z"))
    .transform(v => v.toISOString()),
