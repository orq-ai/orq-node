...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-09-06T12:48:29.220Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-09-06T12:48:29.219Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-09-06T12:48:29.218Z"))
    .transform(v => v.toISOString()),
