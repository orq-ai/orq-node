...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-05T08:11:41.663Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-05T08:11:41.662Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-05T08:11:41.661Z"))
    .transform(v => v.toISOString()),
