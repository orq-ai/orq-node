...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-08T12:18:14.831Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-08T12:18:14.830Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-08T12:18:14.829Z"))
    .transform(v => v.toISOString()),
