...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-24T20:10:51.067Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-24T20:10:51.066Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-24T20:10:51.065Z"))
    .transform(v => v.toISOString()),
