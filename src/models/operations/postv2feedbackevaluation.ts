...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-04T22:50:47.362Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-04T22:50:47.361Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-04T22:50:47.360Z"))
    .transform(v => v.toISOString()),
