...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-09T02:05:52.028Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-09T02:05:52.027Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-09T02:05:52.026Z"))
    .transform(v => v.toISOString()),
