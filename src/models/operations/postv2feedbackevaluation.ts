...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-05T21:45:08.899Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-05T21:45:08.898Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-05T21:45:08.897Z"))
    .transform(v => v.toISOString()),
