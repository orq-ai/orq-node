...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-17T21:16:43.639Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-17T21:16:43.638Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-17T21:16:43.637Z"))
    .transform(v => v.toISOString()),
