...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.806Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.805Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.804Z"))
    .transform(v => v.toISOString()),
