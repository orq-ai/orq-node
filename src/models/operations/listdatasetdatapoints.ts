...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:21:23.081Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:21:23.080Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:21:23.079Z"))
    .transform(v => v.toISOString()),
