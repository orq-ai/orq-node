...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-16T16:11:34.156Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-16T16:11:34.154Z"))
    .transform(v => v.toISOString()),
