...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-23T22:32:50.796Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T22:32:50.795Z"))
    .transform(v => v.toISOString()),
