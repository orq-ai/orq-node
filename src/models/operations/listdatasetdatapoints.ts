...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T17:17:38.759Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T17:17:38.758Z"))
    .transform(v => v.toISOString()),
