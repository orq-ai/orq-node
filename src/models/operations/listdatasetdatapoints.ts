...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-10T20:54:35.421Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T20:54:35.420Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T20:54:35.419Z"))
    .transform(v => v.toISOString()),
