...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.734Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.733Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.732Z"))
    .transform(v => v.toISOString()),
