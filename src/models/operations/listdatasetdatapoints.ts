...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.838Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.837Z"))
    .transform(v => v.toISOString()),
