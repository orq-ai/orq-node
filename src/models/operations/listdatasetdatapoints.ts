...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.401Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.400Z"))
    .transform(v => v.toISOString()),
