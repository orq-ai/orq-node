...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.916Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.915Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.914Z"))
    .transform(v => v.toISOString()),
