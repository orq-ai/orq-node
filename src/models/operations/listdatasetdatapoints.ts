...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T14:03:48.742Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T14:03:48.741Z"))
    .transform(v => v.toISOString()),
