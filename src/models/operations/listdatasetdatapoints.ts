...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T17:59:52.895Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T17:59:52.894Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T17:59:52.893Z"))
    .transform(v => v.toISOString()),
