...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.323Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.322Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.321Z"))
    .transform(v => v.toISOString()),
