...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T22:34:12.027Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T22:34:12.026Z"))
    .transform(v => v.toISOString()),
