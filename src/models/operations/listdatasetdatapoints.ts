...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T21:22:20.074Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T21:22:20.073Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T21:22:20.072Z"))
    .transform(v => v.toISOString()),
