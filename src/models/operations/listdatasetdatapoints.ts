...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T07:29:45.204Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T07:29:45.203Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T07:29:45.202Z"))
    .transform(v => v.toISOString()),
