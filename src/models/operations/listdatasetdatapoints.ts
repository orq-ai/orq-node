...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:03:01.596Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:03:01.595Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:03:01.594Z"))
    .transform(v => v.toISOString()),
