...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.737Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.736Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.735Z"))
    .transform(v => v.toISOString()),
