...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T12:57:44.520Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T12:57:44.519Z"))
    .transform(v => v.toISOString()),
