...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-01T19:29:12.831Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-01T19:29:12.830Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-01T19:29:12.829Z"))
    .transform(v => v.toISOString()),
