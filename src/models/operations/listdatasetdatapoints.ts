...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.749Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.748Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.747Z"))
    .transform(v => v.toISOString()),
