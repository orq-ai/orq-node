...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T13:08:40.971Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T13:08:40.970Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T13:08:40.969Z"))
    .transform(v => v.toISOString()),
