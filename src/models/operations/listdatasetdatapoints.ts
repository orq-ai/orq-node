...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.252Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.251Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.250Z"))
    .transform(v => v.toISOString()),
