...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-11T16:53:42.741Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-11T16:53:42.740Z"))
    .transform(v => v.toISOString()),
