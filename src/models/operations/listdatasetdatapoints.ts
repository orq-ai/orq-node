...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T08:05:01.291Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T08:05:01.290Z"))
    .transform(v => v.toISOString()),
