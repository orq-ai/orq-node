...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T14:00:50.877Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T14:00:50.876Z"))
    .transform(v => v.toISOString()),
