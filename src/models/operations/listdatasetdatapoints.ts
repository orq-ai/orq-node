...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T21:18:31.348Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T21:18:31.347Z"))
    .transform(v => v.toISOString()),
