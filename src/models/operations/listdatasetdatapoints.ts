...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T20:20:29.348Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T20:20:29.347Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T20:20:29.346Z"))
    .transform(v => v.toISOString()),
