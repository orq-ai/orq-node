...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:46:00.183Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:46:00.182Z"))
    .transform(v => v.toISOString()),
