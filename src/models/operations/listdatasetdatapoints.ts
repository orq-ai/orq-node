...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T15:10:02.735Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T15:10:02.732Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T15:10:02.731Z"))
    .transform(v => v.toISOString()),
