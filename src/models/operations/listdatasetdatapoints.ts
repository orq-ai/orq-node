...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:00.976Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:00.975Z"))
    .transform(v => v.toISOString()),
