...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T12:20:29.098Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T12:20:29.097Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T12:20:29.096Z"))
    .transform(v => v.toISOString()),
