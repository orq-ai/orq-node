...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:51:23.788Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:51:23.787Z"))
    .transform(v => v.toISOString()),
