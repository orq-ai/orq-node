...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.862Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.861Z"))
    .transform(v => v.toISOString()),
