...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.325Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.324Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.323Z"))
    .transform(v => v.toISOString()),
