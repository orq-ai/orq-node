...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T09:53:55.289Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T09:53:55.288Z"))
    .transform(v => v.toISOString()),
