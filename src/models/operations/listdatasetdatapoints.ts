...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.154Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.151Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.150Z"))
    .transform(v => v.toISOString()),
