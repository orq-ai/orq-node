...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T16:24:36.050Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T16:24:36.049Z"))
    .transform(v => v.toISOString()),
