...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-28T13:35:56.550Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-28T13:35:56.549Z"))
    .transform(v => v.toISOString()),
