...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-27T11:10:57.941Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-27T11:10:57.940Z"))
    .transform(v => v.toISOString()),
