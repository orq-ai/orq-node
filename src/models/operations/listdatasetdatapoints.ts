...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:54:00.706Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:54:00.705Z"))
    .transform(v => v.toISOString()),
