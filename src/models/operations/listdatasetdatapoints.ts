...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.461Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.458Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.455Z"))
    .transform(v => v.toISOString()),
