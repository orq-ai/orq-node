...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.356Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.348Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.347Z"))
    .transform(v => v.toISOString()),
