...
export const DataCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KCV0ERJFT2V8VF6D8DH0J5GJ"),
  path: z.string(),
  key: z.string(),
...
export const DataCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  DataCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KCV0ERJFT2V8VF6D8DH0J5GJ"),
  path: z.string(),
  key: z.string(),
...
export const DataTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KCV0ERJEZBGJV6Z9HASGG95B"),
  name: z.string(),
...
export const DataMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KCV0ERJCAFPTFQSRPFGAP82R"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataMCPTool$outboundSchema: z.ZodType<
  ...
  DataMCPTool
> = z.object({
  id: z.string().default("tool_01KCV0ERJCAFPTFQSRPFGAP82R"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KCV0ERJ8ZMKMWEG1AT5JT42H"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$outboundSchema: z.ZodType<
  ...
  DataHTTPTool
> = z.object({
  id: z.string().default("tool_01KCV0ERJ8ZMKMWEG1AT5JT42H"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KCV0ERJ67W8MAZAWYA1CA47M"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  DataJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KCV0ERJ67W8MAZAWYA1CA47M"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KCV0ERJ4YKE5JHCGG7APN5K2"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$outboundSchema: z.ZodType<
  ...
  DataFunctionTool
> = z.object({
  id: z.string().default("tool_01KCV0ERJ4YKE5JHCGG7APN5K2"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
