...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.348Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.347Z"))
    .transform(v => v.toISOString()),
