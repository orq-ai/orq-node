...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T22:34:12.050Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T22:34:12.049Z"))
    .transform(v => v.toISOString()),
