...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:29:54.179Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:29:54.178Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:29:54.177Z"))
    .transform(v => v.toISOString()),
