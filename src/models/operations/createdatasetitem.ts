...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T14:03:48.762Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T14:03:48.761Z"))
    .transform(v => v.toISOString()),
