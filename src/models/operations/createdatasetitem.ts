...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.757Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.756Z"))
    .transform(v => v.toISOString()),
