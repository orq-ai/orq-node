...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T11:23:54.067Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T11:23:54.066Z"))
    .transform(v => v.toISOString()),
