...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:51:23.805Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:51:23.804Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:51:23.803Z"))
    .transform(v => v.toISOString()),
