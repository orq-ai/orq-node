...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T13:31:29.516Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T13:31:29.515Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T13:31:29.514Z"))
    .transform(v => v.toISOString()),
