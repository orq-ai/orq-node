...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.434Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.433Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.432Z"))
    .transform(v => v.toISOString()),
