...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.822Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.821Z"))
    .transform(v => v.toISOString()),
