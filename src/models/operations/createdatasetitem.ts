...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-08T14:27:55.939Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-08T14:27:55.938Z"))
    .transform(v => v.toISOString()),
