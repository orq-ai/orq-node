...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.774Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.762Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.761Z"))
    .transform(v => v.toISOString()),
