...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T16:24:36.064Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T16:24:36.063Z"))
    .transform(v => v.toISOString()),
