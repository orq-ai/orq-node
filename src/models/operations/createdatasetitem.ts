...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.780Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.779Z"))
    .transform(v => v.toISOString()),
