...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T13:08:41.000Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T13:08:40.999Z"))
    .transform(v => v.toISOString()),
