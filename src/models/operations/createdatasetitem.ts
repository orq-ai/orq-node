...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:01.002Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:01.001Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:01.000Z"))
    .transform(v => v.toISOString()),
