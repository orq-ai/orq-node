...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T21:22:20.100Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T21:22:20.099Z"))
    .transform(v => v.toISOString()),
