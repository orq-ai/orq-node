...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.861Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.860Z"))
    .transform(v => v.toISOString()),
