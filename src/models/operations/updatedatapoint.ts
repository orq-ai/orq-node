...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.805Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T15:51:35.804Z"))
    .transform(v => v.toISOString()),
