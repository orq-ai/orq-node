...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.440Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.439Z"))
    .transform(v => v.toISOString()),
