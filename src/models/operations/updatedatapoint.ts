...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T15:29:41.627Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T15:29:41.626Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T15:29:41.623Z"))
    .transform(v => v.toISOString()),
