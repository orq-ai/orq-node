...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:21:23.125Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:21:23.124Z"))
    .transform(v => v.toISOString()),
