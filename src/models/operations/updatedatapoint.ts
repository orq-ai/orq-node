...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:29:54.205Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:29:54.204Z"))
    .transform(v => v.toISOString()),
