...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.915Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.914Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.913Z"))
    .transform(v => v.toISOString()),
