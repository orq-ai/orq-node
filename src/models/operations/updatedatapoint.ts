...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.857Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T21:08:59.856Z"))
    .transform(v => v.toISOString()),
