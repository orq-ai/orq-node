...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.378Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T07:34:11.377Z"))
    .transform(v => v.toISOString()),
