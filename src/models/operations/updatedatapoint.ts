...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-11T16:53:42.821Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-11T16:53:42.820Z"))
    .transform(v => v.toISOString()),
