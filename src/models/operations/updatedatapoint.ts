...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T15:10:02.793Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T15:10:02.792Z"))
    .transform(v => v.toISOString()),
