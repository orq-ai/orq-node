...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.900Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.899Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T15:17:57.898Z"))
    .transform(v => v.toISOString()),
