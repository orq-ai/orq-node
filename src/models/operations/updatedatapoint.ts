...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.975Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.974Z"))
    .transform(v => v.toISOString()),
