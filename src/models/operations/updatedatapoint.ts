...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:54:32.261Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:54:32.260Z"))
    .transform(v => v.toISOString()),
