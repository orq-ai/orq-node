...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T13:31:29.554Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T13:31:29.553Z"))
    .transform(v => v.toISOString()),
