...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:19:28.289Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:19:28.288Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:19:28.287Z"))
    .transform(v => v.toISOString()),
