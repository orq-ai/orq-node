...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T17:59:52.947Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T17:59:52.946Z"))
    .transform(v => v.toISOString()),
