...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T17:17:38.814Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T17:17:38.813Z"))
    .transform(v => v.toISOString()),
