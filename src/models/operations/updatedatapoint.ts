...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T08:03:06.728Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T08:03:06.727Z"))
    .transform(v => v.toISOString()),
