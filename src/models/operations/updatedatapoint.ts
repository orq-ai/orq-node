...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T07:29:45.259Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T07:29:45.258Z"))
    .transform(v => v.toISOString()),
