...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.314Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.313Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.312Z"))
    .transform(v => v.toISOString()),
