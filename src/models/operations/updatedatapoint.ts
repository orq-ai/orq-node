...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-22T22:56:02.016Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T22:56:02.015Z"))
    .transform(v => v.toISOString()),
