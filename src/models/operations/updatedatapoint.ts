...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.786Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:11:45.785Z"))
    .transform(v => v.toISOString()),
