...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T22:06:45.218Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T22:06:45.217Z"))
    .transform(v => v.toISOString()),
