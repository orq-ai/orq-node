...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T12:57:44.581Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T12:57:44.580Z"))
    .transform(v => v.toISOString()),
