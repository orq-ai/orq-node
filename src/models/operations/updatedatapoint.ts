...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T20:20:29.400Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T20:20:29.399Z"))
    .transform(v => v.toISOString()),
