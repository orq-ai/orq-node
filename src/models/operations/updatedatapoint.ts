...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:46:00.244Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:46:00.243Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:46:00.242Z"))
    .transform(v => v.toISOString()),
