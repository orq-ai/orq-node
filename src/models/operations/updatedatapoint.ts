...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.236Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.235Z"))
    .transform(v => v.toISOString()),
