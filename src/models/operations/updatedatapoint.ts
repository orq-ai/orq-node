...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-01T10:30:08.743Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-01T10:30:08.742Z"))
    .transform(v => v.toISOString()),
