...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T08:35:41.300Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T08:35:41.299Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T08:35:41.298Z"))
    .transform(v => v.toISOString()),
