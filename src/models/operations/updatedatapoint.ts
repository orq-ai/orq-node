...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T11:23:54.100Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T11:23:54.099Z"))
    .transform(v => v.toISOString()),
