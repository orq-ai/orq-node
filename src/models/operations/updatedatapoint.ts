...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.531Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.530Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.523Z"))
    .transform(v => v.toISOString()),
