...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:21:10.331Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:21:10.330Z"))
    .transform(v => v.toISOString()),
