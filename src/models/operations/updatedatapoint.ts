...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T09:53:55.348Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T09:53:55.347Z"))
    .transform(v => v.toISOString()),
