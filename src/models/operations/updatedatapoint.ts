...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.459Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T21:27:54.458Z"))
    .transform(v => v.toISOString()),
