...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T12:40:28.435Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T12:40:28.428Z"))
    .transform(v => v.toISOString()),
