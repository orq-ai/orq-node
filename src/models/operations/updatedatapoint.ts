...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:52:10.180Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:52:10.179Z"))
    .transform(v => v.toISOString()),
