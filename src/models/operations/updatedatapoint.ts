...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:54:00.763Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:54:00.762Z"))
    .transform(v => v.toISOString()),
