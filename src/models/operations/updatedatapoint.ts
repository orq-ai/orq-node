...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.835Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T19:15:23.834Z"))
    .transform(v => v.toISOString()),
