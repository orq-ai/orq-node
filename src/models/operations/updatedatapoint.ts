...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.390Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.389Z"))
    .transform(v => v.toISOString()),
