...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T14:21:27.293Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T14:21:27.292Z"))
    .transform(v => v.toISOString()),
