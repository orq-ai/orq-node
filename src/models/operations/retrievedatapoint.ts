...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T08:05:01.308Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T08:05:01.307Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T08:05:01.306Z"))
    .transform(v => v.toISOString()),
