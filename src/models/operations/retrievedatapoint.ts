...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:19:28.243Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-23T18:19:28.242Z"))
    .transform(v => v.toISOString()),
