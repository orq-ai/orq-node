...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.336Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T20:22:38.335Z"))
    .transform(v => v.toISOString()),
