...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:00.983Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T11:28:00.982Z"))
    .transform(v => v.toISOString()),
