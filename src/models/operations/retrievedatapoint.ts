...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T21:18:31.355Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T21:18:31.354Z"))
    .transform(v => v.toISOString()),
