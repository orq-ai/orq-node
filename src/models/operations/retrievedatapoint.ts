...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T08:35:41.261Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T08:35:41.260Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T08:35:41.257Z"))
    .transform(v => v.toISOString()),
