...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:52:10.137Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:52:10.136Z"))
    .transform(v => v.toISOString()),
