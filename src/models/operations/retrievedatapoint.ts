...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:03:01.604Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T15:03:01.603Z"))
    .transform(v => v.toISOString()),
