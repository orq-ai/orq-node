...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T14:21:27.248Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T14:21:27.247Z"))
    .transform(v => v.toISOString()),
