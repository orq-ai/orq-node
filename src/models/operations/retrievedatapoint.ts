...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-28T13:35:56.557Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-28T13:35:56.556Z"))
    .transform(v => v.toISOString()),
