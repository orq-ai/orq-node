...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-16T16:11:34.168Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-16T16:11:34.167Z"))
    .transform(v => v.toISOString()),
