...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.481Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T09:04:41.480Z"))
    .transform(v => v.toISOString()),
