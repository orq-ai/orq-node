...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.380Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:11:36.379Z"))
    .transform(v => v.toISOString()),
