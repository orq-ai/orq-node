...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T09:53:55.304Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T09:53:55.303Z"))
    .transform(v => v.toISOString()),
