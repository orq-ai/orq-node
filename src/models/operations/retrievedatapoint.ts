...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.928Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T09:33:38.927Z"))
    .transform(v => v.toISOString()),
