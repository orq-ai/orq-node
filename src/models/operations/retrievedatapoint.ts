...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-10T20:54:35.432Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T20:54:35.431Z"))
    .transform(v => v.toISOString()),
