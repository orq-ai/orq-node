...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.869Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:15:58.868Z"))
    .transform(v => v.toISOString()),
