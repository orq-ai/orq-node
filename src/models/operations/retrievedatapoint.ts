...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T15:29:41.587Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T15:29:41.586Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T15:29:41.579Z"))
    .transform(v => v.toISOString()),
