...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-31T12:20:29.115Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-31T12:20:29.114Z"))
    .transform(v => v.toISOString()),
