...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-27T11:10:57.948Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-27T11:10:57.947Z"))
    .transform(v => v.toISOString()),
