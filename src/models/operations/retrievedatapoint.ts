...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.174Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-15T20:01:50.173Z"))
    .transform(v => v.toISOString()),
