...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.263Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.262Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T13:59:11.261Z"))
    .transform(v => v.toISOString()),
