...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:36:35.681Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T08:36:35.680Z"))
    .transform(v => v.toISOString()),
