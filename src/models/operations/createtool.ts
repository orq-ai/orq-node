...
export const ResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8VM3MEN8DNNH6E03T3RS6G8"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody5$outboundSchema: z.ZodType<
  ...
  ResponseBody5
> = z.object({
  id: z.string().default("01K8VM3MEN8DNNH6E03T3RS6G8"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8VM3MEK4751JYB5B9MNP5J3"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$outboundSchema: z.ZodType<
  ...
  ResponseBody4
> = z.object({
  id: z.string().default("01K8VM3MEK4751JYB5B9MNP5J3"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8VM3MEJA023S2G190WYBB8G"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$outboundSchema: z.ZodType<
  ...
  ResponseBody3
> = z.object({
  id: z.string().default("01K8VM3MEJA023S2G190WYBB8G"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8VM3MEH9KZQNKBDWR5MHDNJ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$outboundSchema: z.ZodType<
  ...
  ResponseBody2
> = z.object({
  id: z.string().default("01K8VM3MEH9KZQNKBDWR5MHDNJ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8VM3MEF8DGRB3WS8NMT4FM7"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$outboundSchema: z.ZodType<
  ...
  ResponseBody1
> = z.object({
  id: z.string().default("01K8VM3MEF8DGRB3WS8NMT4FM7"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
