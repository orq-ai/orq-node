...
export const ResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8ZFF9AFYG2XN64W95RGQZCP"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody5$outboundSchema: z.ZodType<
  ...
  ResponseBody5
> = z.object({
  id: z.string().default("01K8ZFF9AFYG2XN64W95RGQZCP"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8ZFF9AETZP6GE5T1FWSR86D"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$outboundSchema: z.ZodType<
  ...
  ResponseBody4
> = z.object({
  id: z.string().default("01K8ZFF9AETZP6GE5T1FWSR86D"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8ZFF9ABPPRMA4KM6BDT0E9J"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$outboundSchema: z.ZodType<
  ...
  ResponseBody3
> = z.object({
  id: z.string().default("01K8ZFF9ABPPRMA4KM6BDT0E9J"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8ZFF9AAQYM5MV8DQP0Q07Z1"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$outboundSchema: z.ZodType<
  ...
  ResponseBody2
> = z.object({
  id: z.string().default("01K8ZFF9AAQYM5MV8DQP0Q07Z1"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K8ZFF9A9SZEXV59HAWRZM3X4"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$outboundSchema: z.ZodType<
  ...
  ResponseBody1
> = z.object({
  id: z.string().default("01K8ZFF9A9SZEXV59HAWRZM3X4"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
