 ...
 */
export type ResponseCodeInterpreterCallInProgressStreamEvent = {
  /**
...
/** @internal */
export const ResponseCodeInterpreterCallInProgressStreamEvent$inboundSchema:
  z.ZodType<
...
export function responseCodeInterpreterCallInProgressStreamEventFromJSON(
  jsonString: string,
): SafeParseResult<
  ResponseCodeInterpreterCallInProgressStreamEvent,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      ResponseCodeInterpreterCallInProgressStreamEvent$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ResponseCodeInterpreterCallInProgressStreamEvent' from JSON`,
  );
}
