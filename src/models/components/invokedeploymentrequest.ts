...
/** @internal */
export const InvokeDeploymentRequest24$inboundSchema: z.ZodType<
  InvokeDeploymentRequest24,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function invokeDeploymentRequest24FromJSON(
  jsonString: string,
): SafeParseResult<InvokeDeploymentRequest24, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => InvokeDeploymentRequest24$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InvokeDeploymentRequest24' from JSON`,
  );
}
...
> = z.union([
  ...
  ImageContentPartSchema$inboundSchema,
  AudioContentPartSchema$inboundSchema,
  z.lazy(() => InvokeDeploymentRequest24$inboundSchema),
]);
/** @internal */
