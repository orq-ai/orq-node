 ...
 * Internal server error
 */
export class EvalsRagasHarmfulnessEvalsResponseBody extends OrqError {
  /** The original data that was passed to this error instance. */
  data$: EvalsRagasHarmfulnessEvalsResponseBodyData;

  constructor(
    err: EvalsRagasHarmfulnessEvalsResponseBodyData,
 ...
 * Evaluator not found
 */
export class EvalsRagasHarmfulnessResponseBody extends OrqError {
  /** The original data that was passed to this error instance. */
  data$: EvalsRagasHarmfulnessResponseBodyData;

  constructor(
    err: EvalsRagasHarmfulnessResponseBodyData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = err.message || `API error occurred: ${JSON.stringify(err)}`;
    super(message, httpMeta);
