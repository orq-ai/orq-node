...
import { alertsCheckNow } from "../funcs/alertsCheckNow.js";
...
export class Alerts extends ClientSDK {
   ...
   */
  async checkNow(
    request: operations.AlertCheckNowRequest,
    options?: RequestOptions,
  ): Promise<components.CheckAlertNowResponse> {
    return unwrapAsync(alertsCheckNow(
      this,
      request,
      options,
    ));
