...
| `loadBalancer`                                                                                                                                                                                               | *operations.CreateImageVariationRouterImagesVariationsLoadBalancer*                                                                                                                                          | :heavy_minus_sign:                                                                                                                                                                                           | Load balancer configuration for the request.                                                                                                                                                                 | {<br/>"type": "weight_based",<br/>"models": [<br/>{<br/>"model": "openai/gpt-4o",<br/>"weight": 0.7<br/>},<br/>{<br/>"model": "anthropic/claude-3-5-sonnet",<br/>"weight": 0.3<br/>}<br/>]<br/>}             |
