...
```typescript
import { GetV2AnnotationQueuesAnnotationQueueIdItemsItemIdResponseBodyData } from "@orq-ai/node/models/operations";

let value: GetV2AnnotationQueuesAnnotationQueueIdItemsItemIdResponseBodyData =
  {};
```
