...
```typescript
import { RetrieveAnnotationQueueItemResponseBodyAgenticRagConfig } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemResponseBodyAgenticRagConfig = {
  model: "Beetle",
};
```
