# DeploymentGetLogsEvalsDeploymentsResponseRequestProperties
...
```typescript
import { DeploymentGetLogsEvalsDeploymentsResponseRequestProperties } from "@orq-ai/node/models/operations";

let value: DeploymentGetLogsEvalsDeploymentsResponseRequestProperties = {};
```
