...
| `headers`                                                                                                          | Record<string, [operations.UpdateToolRequestBodyHeaders](../../models/operations/updatetoolrequestbodyheaders.md)> | :heavy_minus_sign:                                                                                                 | HTTP headers for MCP server requests (encrypted format)                                                            |
