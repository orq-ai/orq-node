# DeploymentGetLogsEvalsRequestProperties
...
```typescript
import { DeploymentGetLogsEvalsRequestProperties } from "@orq-ai/node/models/operations";

let value: DeploymentGetLogsEvalsRequestProperties = {};
```
