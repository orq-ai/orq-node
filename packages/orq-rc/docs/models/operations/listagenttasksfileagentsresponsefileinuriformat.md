...
```typescript
import { ListAgentTasksFileAgentsResponseFileInURIFormat } from "@orq-ai/node/models/operations";

let value: ListAgentTasksFileAgentsResponseFileInURIFormat = {
  uri: "https://jittery-scholarship.net/",
};
```
