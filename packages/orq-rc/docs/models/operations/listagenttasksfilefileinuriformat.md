...
```typescript
import { ListAgentTasksFileFileInURIFormat } from "@orq-ai/node/models/operations";

let value: ListAgentTasksFileFileInURIFormat = {
  uri: "https://well-off-possession.org",
};
```
