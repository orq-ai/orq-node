...
| `messages`                                                                              | [components.ExtendedMessage](../../models/components/extendedmessage.md)[]              | :heavy_minus_sign:                                                                      | Array of messages in the task conversation. Only present when blocking mode is enabled. |
