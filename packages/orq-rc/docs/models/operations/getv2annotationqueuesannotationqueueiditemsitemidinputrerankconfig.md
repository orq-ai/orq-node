...
```typescript
import { GetV2AnnotationQueuesAnnotationQueueIdItemsItemIdInputRerankConfig } from "@orq-ai/node/models/operations";

let value: GetV2AnnotationQueuesAnnotationQueueIdItemsItemIdInputRerankConfig =
  {
