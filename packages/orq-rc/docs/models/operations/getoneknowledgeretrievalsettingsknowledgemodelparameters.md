...
```typescript
import { GetOneKnowledgeRetrievalSettingsKnowledgeModelParameters } from "@orq-ai/node/models/operations";

let value: GetOneKnowledgeRetrievalSettingsKnowledgeModelParameters = {};
```
