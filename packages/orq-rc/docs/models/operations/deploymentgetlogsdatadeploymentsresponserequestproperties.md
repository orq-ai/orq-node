# DeploymentGetLogsDataDeploymentsResponseRequestProperties
...
```typescript
import { DeploymentGetLogsDataDeploymentsResponseRequestProperties } from "@orq-ai/node/models/operations";

let value: DeploymentGetLogsDataDeploymentsResponseRequestProperties = {};
```
