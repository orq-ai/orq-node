...
```typescript
import { RetrieveAgentRequestFallbackModelConfigurationRetry } from "@orq-ai/node/models/operations";

let value: RetrieveAgentRequestFallbackModelConfigurationRetry = {
  onCodes: [
    429,
    500,
    502,
