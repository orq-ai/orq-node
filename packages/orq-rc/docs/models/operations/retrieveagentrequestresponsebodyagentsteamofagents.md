...
```typescript
import { RetrieveAgentRequestResponseBodyAgentsTeamOfAgents } from "@orq-ai/node/models/operations";

let value: RetrieveAgentRequestResponseBodyAgentsTeamOfAgents = {
  key: "<key>",
};
```
