...
```typescript
import { DataEvaluators } from "@orq-ai/node/models/operations";

let value: DataEvaluators = {
  id: "<id>",
  executeOn: "input",
};
```
...
| `executeOn`                                                                                                                                                            | [operations.DataExecuteOn](../../models/operations/dataexecuteon.md)                                                                                                   | :heavy_check_mark:                                                                                                                                                     | Determines whether the evaluator runs on the agent input (user message) or output (agent response).                                                                    |