...
| `headers`                                                                                                                      | Record<string, [operations.UpdateToolResponseBodyToolsHeaders](../../models/operations/updatetoolresponsebodytoolsheaders.md)> | :heavy_minus_sign:                                                                                                             | The headers to send with the request.                                                                                          |
