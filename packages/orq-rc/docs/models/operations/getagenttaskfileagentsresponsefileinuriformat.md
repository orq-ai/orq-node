...
```typescript
import { GetAgentTaskFileAgentsResponseFileInURIFormat } from "@orq-ai/node/models/operations";

let value: GetAgentTaskFileAgentsResponseFileInURIFormat = {
  uri: "https://alienated-tectonics.info",
};
```
