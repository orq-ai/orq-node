...
```typescript
import { RetrieveAgentRequestResponseBodyTools } from "@orq-ai/node/models/operations";

let value: RetrieveAgentRequestResponseBodyTools = {
  id: "<id>",
  actionType: "<value>",
};
```
...
| `conditions`                                                                             | [operations.ResponseBodyConditions](../../models/operations/responsebodyconditions.md)[] | :heavy_minus_sign:                                                                       | N/A                                                                                      |
