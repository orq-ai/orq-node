...
```typescript
import { ListPromptVersions24 } from "@orq-ai/node/models/operations";

let value: ListPromptVersions24 = {
  type: "file",
  file: {},
};
```
...
| `cacheControl`                                                                                           | [operations.ListPromptVersions2CacheControl](../../models/operations/listpromptversions2cachecontrol.md) | :heavy_minus_sign:                                                                                       | N/A                                                                                                      |
