...
```typescript
import { StreamRunAgentFileAgentsResponse200TextEventStreamFileInURIFormat } from "@orq-ai/node/models/operations";

let value: StreamRunAgentFileAgentsResponse200TextEventStreamFileInURIFormat = {
  uri: "https://emotional-filter.info/",
};
```
