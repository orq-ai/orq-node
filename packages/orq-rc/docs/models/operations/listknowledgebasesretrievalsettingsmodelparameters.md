...
```typescript
import { ListKnowledgeBasesRetrievalSettingsModelParameters } from "@orq-ai/node/models/operations";

let value: ListKnowledgeBasesRetrievalSettingsModelParameters = {};
```
