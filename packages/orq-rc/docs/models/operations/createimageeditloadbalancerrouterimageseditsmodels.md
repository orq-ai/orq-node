...
```typescript
import { CreateImageEditLoadBalancerRouterImagesEditsModels } from "@orq-ai/node/models/operations";

let value: CreateImageEditLoadBalancerRouterImagesEditsModels = {
  model: "openai/gpt-4o",
  weight: 0.7,
};
```
