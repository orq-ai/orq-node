...
| `headers`                                                                                                     | Record<string, *operations.CreateToolResponseBodyToolsHeaders*>                                               | :heavy_minus_sign:                                                                                            | The headers to send with the request. Can be a string value or an object with value and encrypted properties. |
