...
| `headers`                                                                                                                          | Record<string, [operations.RetrieveToolResponseBodyToolsHeaders](../../models/operations/retrievetoolresponsebodytoolsheaders.md)> | :heavy_minus_sign:                                                                                                                 | The headers to send with the request.                                                                                              |
