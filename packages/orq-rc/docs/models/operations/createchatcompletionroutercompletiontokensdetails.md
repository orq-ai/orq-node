...
```typescript
import { CreateChatCompletionRouterCompletionTokensDetails } from "@orq-ai/node/models/operations";

let value: CreateChatCompletionRouterCompletionTokensDetails = {};
```
