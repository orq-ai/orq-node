...
```typescript
import { CreateKnowledgeRetrievalSettingsKnowledgeModelParameters } from "@orq-ai/node/models/operations";

let value: CreateKnowledgeRetrievalSettingsKnowledgeModelParameters = {};
```
