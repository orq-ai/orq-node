...
```typescript
import { StreamRunAgentAgentToolInputRunCodeInterpreterTool } from "@orq-ai/node/models/operations";

let value: StreamRunAgentAgentToolInputRunCodeInterpreterTool = {
