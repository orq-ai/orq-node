...
```typescript
import { StreamRunAgentDataTools } from "@orq-ai/node/models/operations";

let value: StreamRunAgentDataTools = {
  id: "<id>",
  actionType: "<value>",
};
```
...
| `conditions`                                                                                         | [operations.StreamRunAgentDataConditions](../../models/operations/streamrunagentdataconditions.md)[] | :heavy_minus_sign:                                                                                   | N/A                                                                                                  |
