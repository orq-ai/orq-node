...
| `templateVariables`                                                                                                           | *string*[]                                                                                                                    | :heavy_minus_sign:                                                                                                            | Names of template variables detected in server_url and headers. Used by the FE to prompt for one-time values on sync/refresh. |