...
```typescript
import { GetEvalResponseBodyModelParameters } from "@orq-ai/node/models/operations";

let value: GetEvalResponseBodyModelParameters = {};
```
...
| `budgetTokens`     | *number*           | :heavy_minus_sign: | N/A                |