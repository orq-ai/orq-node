...
```typescript
import { RetrieveAgentRequestTools } from "@orq-ai/node/models/operations";

let value: RetrieveAgentRequestTools = {
  id: "<id>",
  actionType: "<value>",
};
```
...
| `conditions`                                                                                             | [operations.RetrieveAgentRequestConditions](../../models/operations/retrieveagentrequestconditions.md)[] | :heavy_minus_sign:                                                                                       | N/A                                                                                                      |
