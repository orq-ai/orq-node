...
```typescript
import { StreamRunAgentFallbackModelConfigurationAgentsRetry } from "@orq-ai/node/models/operations";

let value: StreamRunAgentFallbackModelConfigurationAgentsRetry = {
  onCodes: [
    429,
    500,
    502,
