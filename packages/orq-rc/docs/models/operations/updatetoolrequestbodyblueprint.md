...
| `headers`                                                                                                                    | Record<string, [operations.UpdateToolRequestBodyToolsHeaders](../../models/operations/updatetoolrequestbodytoolsheaders.md)> | :heavy_minus_sign:                                                                                                           | The headers to send with the request.                                                                                        |
