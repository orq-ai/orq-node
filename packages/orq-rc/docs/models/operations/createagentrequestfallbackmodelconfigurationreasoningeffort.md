...
```typescript
import { CreateAgentRequestFallbackModelConfigurationReasoningEffort } from "@orq-ai/node/models/operations";

let value: CreateAgentRequestFallbackModelConfigurationReasoningEffort = "low";
```
