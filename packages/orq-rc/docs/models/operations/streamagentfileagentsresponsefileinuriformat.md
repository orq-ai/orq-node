...
```typescript
import { StreamAgentFileAgentsResponseFileInURIFormat } from "@orq-ai/node/models/operations";

let value: StreamAgentFileAgentsResponseFileInURIFormat = {
  uri: "https://heartfelt-synergy.net",
};
```
