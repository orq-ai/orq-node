...
```typescript
import { InputFunction } from "@orq-ai/node/models/operations";

let value: InputFunction = {
  name: "<value>",
};
```
...
| `parameters`                                                                                            | [operations.InputParameters](../../models/operations/inputparameters.md)                                | :heavy_minus_sign:                                                                                      | The parameters the functions accepts, described as a JSON Schema object                                 |
