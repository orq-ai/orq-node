...
```typescript
import { GetPromptVersion24 } from "@orq-ai/node/models/operations";

let value: GetPromptVersion24 = {
  type: "file",
  file: {},
};
```
...
| `cacheControl`                                                                                       | [operations.GetPromptVersion2CacheControl](../../models/operations/getpromptversion2cachecontrol.md) | :heavy_minus_sign:                                                                                   | N/A                                                                                                  |
