...
| `type`                                                                                                                           | [operations.UpdateDatapointMessagesDatasetsResponseType](../../models/operations/updatedatapointmessagesdatasetsresponsetype.md) | :heavy_check_mark:                                                                                                               | The type of the tool. Currently, only `function` is supported.                                                                   |
