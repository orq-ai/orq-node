...
```typescript
import { SearchKnowledgeRetrievalConfigKnowledgeModelParameters } from "@orq-ai/node/models/operations";

let value: SearchKnowledgeRetrievalConfigKnowledgeModelParameters = {};
```
