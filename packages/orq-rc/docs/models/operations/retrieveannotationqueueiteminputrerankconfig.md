...
```typescript
import { RetrieveAnnotationQueueItemInputRerankConfig } from "@orq-ai/node/models/operations";

let value: RetrieveAnnotationQueueItemInputRerankConfig = {
...
| `topK`                                                                                                                                   | *number*                                                                                                                                 | :heavy_minus_sign:                                                                                                                       | The number of top results to return after reranking. Defaults to `10`.                                                                   |                                                                                                                                          |