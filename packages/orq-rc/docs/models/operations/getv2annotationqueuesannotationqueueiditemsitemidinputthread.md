...
```typescript
import { GetV2AnnotationQueuesAnnotationQueueIdItemsItemIdInputThread } from "@orq-ai/node/models/operations";

let value: GetV2AnnotationQueuesAnnotationQueueIdItemsItemIdInputThread = {
