# DeploymentGetLogsDataRequestProperties
...
```typescript
import { DeploymentGetLogsDataRequestProperties } from "@orq-ai/node/models/operations";

let value: DeploymentGetLogsDataRequestProperties = {};
```
