...
```typescript
import { StreamAgentFileAgentsFileInURIFormat } from "@orq-ai/node/models/operations";

let value: StreamAgentFileAgentsFileInURIFormat = {
  uri: "https://unlawful-duffel.com/",
};
```
