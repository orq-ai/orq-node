...
```typescript
import { CreateAgentResponseRequestBody } from "@orq-ai/node/models/operations";

let value: CreateAgentResponseRequestBody = {
  message: {
    role: "user",
    parts: [
      {
...
| `thread`                                                                                                                                                                                           | [operations.CreateAgentResponseThread](../../models/operations/createagentresponsethread.md)                                                                                                       | :heavy_minus_sign:                                                                                                                                                                                 | Thread information to group related requests                                                                                                                                                       |
