...
| `headers`                                                                                                                  | Record<string, [operations.RunAgentAgentToolInputRunHeaders](../../models/operations/runagentagenttoolinputrunheaders.md)> | :heavy_minus_sign:                                                                                                         | HTTP headers for MCP server requests with encryption support                                                               |
