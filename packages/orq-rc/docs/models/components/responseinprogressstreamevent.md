...
```typescript
import { ResponseInProgressStreamEvent } from "@orq-ai/node/models/components";

let value: ResponseInProgressStreamEvent = {
  response: {
    background: true,
    completedAt: 943245,
    createdAt: 963158,
...
| `type`                                                                                 | *"response.in_progress"*                                                               | :heavy_check_mark:                                                                     | The event type. Discriminates the payload.                                             |
