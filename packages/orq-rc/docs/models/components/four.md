...
| `file`                                                                                                                         | [components.InvokeDeploymentRequest2File](../../models/components/invokedeploymentrequest2file.md)                             | :heavy_check_mark:                                                                                                             | File data for the content part. Must contain either file_data or uri, but not both.                                            |