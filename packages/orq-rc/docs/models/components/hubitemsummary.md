...
| `entityId`                                                                                                                   | *string*                                                                                                                     | :heavy_minus_sign:                                                                                                           | ID of the workspace entity represented by this hub item. Empty on search results: the field is not part of the search index. |
