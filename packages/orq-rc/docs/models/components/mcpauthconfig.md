...
| `oauth`                                                                                                                        | [components.McpOAuthConfig](../../models/components/mcpoauthconfig.md)                                                         | :heavy_minus_sign:                                                                                                             | OAuth client credentials the gateway presents to the upstream authorization server; set when type is OAUTH_CLIENT_CREDENTIALS. |