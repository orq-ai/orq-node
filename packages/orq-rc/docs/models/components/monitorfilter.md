...
| `op`                                                                                                       | [components.MonitorFilterOp](../../models/components/monitorfilterop.md)                                   | :heavy_check_mark:                                                                                         | Predicate operator. `eq` and `neq` accept exactly one value; `in` and `not_in` accept 1-100 values.        |
