...
| `processingAttempts`                                                               | [components.ProcessingAttempt](../../models/components/processingattempt.md)[]     | :heavy_minus_sign:                                                                 | Processing attempts recorded for the datasource.                                   |
