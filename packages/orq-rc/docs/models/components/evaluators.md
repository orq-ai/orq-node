...
```typescript
import { Evaluators } from "@orq-ai/node/models/components";
...
| `executeOn`                                                                                                                                                            | [components.ExecuteOn](../../models/components/executeon.md)                                                                                                           | :heavy_check_mark:                                                                                                                                                     | Determines whether the evaluator runs on the agent input (user message) or output (agent response).                                                                    |