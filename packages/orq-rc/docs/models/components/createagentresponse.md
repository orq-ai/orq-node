...
| `finishReason`                                                                       | [components.FinishReason](../../models/components/finishreason.md)                   | :heavy_minus_sign:                                                                   | The reason why the agent stopped generating                                          |
| `pendingToolCalls`                                                                   | [components.PendingToolCalls](../../models/components/pendingtoolcalls.md)[]         | :heavy_minus_sign:                                                                   | Tool calls awaiting user response (when finish_reason is function_call)              |