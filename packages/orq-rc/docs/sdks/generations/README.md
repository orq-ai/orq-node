...
<!-- UsageSnippet language="typescript" operationID="createImage" method="post" path="/v2/router/images/generations" -->
```typescript
...
import { routerImagesGenerationsCreate } from "@orq-ai/node/funcs/routerImagesGenerationsCreate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("routerImagesGenerationsCreate failed:", res.error);
  }
}
