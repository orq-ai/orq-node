 ...
 */
export function memoryStoresCreateDocument(
  client: OrqCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateMemoryDocumentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateMemoryDocumentRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.MemoryDocument$inboundSchema),
