 ...
 */
export function modelsCreate(
  client: OrqCore,
  request: operations.ModelCreateRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ModelCreateResponseBody,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ModelCreateRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ModelCreateResponseBody$inboundSchema),
