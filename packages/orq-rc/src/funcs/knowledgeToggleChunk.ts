 ...
 */
export function knowledgeToggleChunk(
  client: OrqCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateChunkEnabledRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ChunksServiceSetEnabledRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc(
    "/v2/knowledge/{knowledge_id}/datasources/{datasource_id}/chunks/{chunk_id}/enabled",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "UpdateChunkEnabled",
    oAuth2Scopes: null,
