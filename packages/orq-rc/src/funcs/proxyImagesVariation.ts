 ...
 */
export function proxyImagesVariation(
  client: OrqCore,
  request: operations.PostV2ProxyImagesVariationsRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostV2ProxyImagesVariationsResponseBody,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostV2ProxyImagesVariationsRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/proxy/images/variations")();
  ...
  const context = {
    ...
    operationID: "post_/v2/proxy/images/variations",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.PostV2ProxyImagesVariationsResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
