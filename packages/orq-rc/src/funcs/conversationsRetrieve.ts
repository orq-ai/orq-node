 ...
 */
export function conversationsRetrieve(
  client: OrqCore,
...
> {
  const input: operations.RetrieveConversationRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.RetrieveConversationRequest$outboundSchema.parse(value),
