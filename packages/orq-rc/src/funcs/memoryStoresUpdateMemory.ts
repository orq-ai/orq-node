 ...
 */
export function memoryStoresUpdateMemory(
  client: OrqCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateMemoryRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateMemoryRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Memory$inboundSchema),
