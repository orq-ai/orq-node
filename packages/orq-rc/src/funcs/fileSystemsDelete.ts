...
export function fileSystemsDelete(
  ...
  Result<
    components.DeleteFileSystemResponse | undefined,
    | OrqError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DeleteFileSystemResponse$inboundSchema.optional()),
    M.nil(204, components.DeleteFileSystemResponse$inboundSchema.optional()),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
