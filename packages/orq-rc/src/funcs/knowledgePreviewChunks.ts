 ...
 */
export function knowledgePreviewChunks(
  client: OrqCore,
  request: operations.PreviewDatasourceChunksRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.DatasourcesServicePreviewChunksResponse,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PreviewDatasourceChunksRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.DatasourcesServicePreviewChunksRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      components.DatasourcesServicePreviewChunksResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
