...
export function knowledgeGetChunksCount(
  ...
  Result<
    components.ChunksServiceCountResponse,
    | OrqError
...
> {
  ...
  const body = encodeJSON("body", payload.ChunksServiceCountRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ChunksServiceCountResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
