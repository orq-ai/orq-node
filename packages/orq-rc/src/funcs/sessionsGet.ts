...
export function sessionsGet(
  ...
  Result<
    operations.GetSessionResponseBody,
    | errors.HonoApiError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const path = pathToFunc("/v2/traces/sessions/{session_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetSessionResponseBody$inboundSchema),
