 ...
 * Edit an Image
 */
export function proxyImagesEdit(
  client: OrqCore,
  request: operations.PostV2ProxyImagesEditsRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostV2ProxyImagesEditsResponseBody,
    | OrqError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostV2ProxyImagesEditsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/proxy/images/edits")();
  ...
  const context = {
    ...
    operationID: "post_/v2/proxy/images/edits",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PostV2ProxyImagesEditsResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
