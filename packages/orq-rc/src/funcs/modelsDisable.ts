...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ModelDisableRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/workspace-models/{model_id}")(pathParams);
