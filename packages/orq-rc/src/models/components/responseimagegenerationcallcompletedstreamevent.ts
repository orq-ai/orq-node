 ...
 */
export type ResponseImageGenerationCallCompletedStreamEvent = {
  /**
...
/** @internal */
export const ResponseImageGenerationCallCompletedStreamEvent$inboundSchema:
  z.ZodType<
...
export function responseImageGenerationCallCompletedStreamEventFromJSON(
  jsonString: string,
): SafeParseResult<
  ResponseImageGenerationCallCompletedStreamEvent,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      ResponseImageGenerationCallCompletedStreamEvent$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ResponseImageGenerationCallCompletedStreamEvent' from JSON`,
  );
}
