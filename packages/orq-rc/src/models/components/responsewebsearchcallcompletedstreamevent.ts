 ...
 */
export type ResponseWebSearchCallCompletedStreamEvent = {
  /**
...
/** @internal */
export const ResponseWebSearchCallCompletedStreamEvent$inboundSchema: z.ZodType<
...
export function responseWebSearchCallCompletedStreamEventFromJSON(
  jsonString: string,
): SafeParseResult<
  ResponseWebSearchCallCompletedStreamEvent,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      ResponseWebSearchCallCompletedStreamEvent$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ResponseWebSearchCallCompletedStreamEvent' from JSON`,
  );
}
