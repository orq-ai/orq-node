 ...
 */
export type ResponseCodeInterpreterCallInterpretingStreamEvent = {
  /**
...
/** @internal */
export const ResponseCodeInterpreterCallInterpretingStreamEvent$inboundSchema:
  z.ZodType<
...
export function responseCodeInterpreterCallInterpretingStreamEventFromJSON(
  jsonString: string,
): SafeParseResult<
  ResponseCodeInterpreterCallInterpretingStreamEvent,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      ResponseCodeInterpreterCallInterpretingStreamEvent$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ResponseCodeInterpreterCallInterpretingStreamEvent' from JSON`,
  );
}
