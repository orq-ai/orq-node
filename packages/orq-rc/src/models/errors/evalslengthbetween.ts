 ...
 * Internal server error
 */
export class EvalsLengthBetweenEvalsResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: EvalsLengthBetweenEvalsResponseBodyData;

  constructor(err: EvalsLengthBetweenEvalsResponseBodyData) {
 ...
 * Evaluator not found
 */
export class EvalsLengthBetweenResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: EvalsLengthBetweenResponseBodyData;

  constructor(err: EvalsLengthBetweenResponseBodyData) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
      : `API error occurred: ${JSON.stringify(err)}`;
    super(message);
