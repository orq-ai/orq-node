 ...
 * Internal server error
 */
export class EvalsContainsEmailEvalsResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: EvalsContainsEmailEvalsResponseBodyData;

  constructor(err: EvalsContainsEmailEvalsResponseBodyData) {
 ...
 * Evaluator not found
 */
export class EvalsContainsEmailResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: EvalsContainsEmailResponseBodyData;

  constructor(err: EvalsContainsEmailResponseBodyData) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
      : `API error occurred: ${JSON.stringify(err)}`;
    super(message);
