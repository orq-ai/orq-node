 ...
 * Internal server error
 */
export class EvalsSentimentClassificationEvalsResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: EvalsSentimentClassificationEvalsResponseBodyData;

  constructor(err: EvalsSentimentClassificationEvalsResponseBodyData) {
 ...
 * Evaluator not found
 */
export class EvalsSentimentClassificationResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: EvalsSentimentClassificationResponseBodyData;

  constructor(err: EvalsSentimentClassificationResponseBodyData) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
      : `API error occurred: ${JSON.stringify(err)}`;
    super(message);
