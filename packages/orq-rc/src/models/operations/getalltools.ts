...
export const DataCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KEXRJ81XF9E7MK72H60W2Y02"),
  path: z.string(),
  key: z.string(),
...
export const DataCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  DataCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KEXRJ81XF9E7MK72H60W2Y02"),
  path: z.string(),
  key: z.string(),
...
export const DataTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KEXRJ81XKKHY520KH725JPSQ"),
  name: z.string(),
...
export const DataMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KEXRJ81VRHH1KX2BWW8C4GA2"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataMCPTool$outboundSchema: z.ZodType<
  ...
  DataMCPTool
> = z.object({
  id: z.string().default("tool_01KEXRJ81VRHH1KX2BWW8C4GA2"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KEXRJ81GPAD0J2N0E1GAWRD6"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$outboundSchema: z.ZodType<
  ...
  DataHTTPTool
> = z.object({
  id: z.string().default("tool_01KEXRJ81GPAD0J2N0E1GAWRD6"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KEXRJ81EAAAZWR9Z4JX1JX7J"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  DataJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KEXRJ81EAAAZWR9Z4JX1JX7J"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KEXRJ81AB6VKSZ9EGNBQSQ5T"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$outboundSchema: z.ZodType<
  ...
  DataFunctionTool
> = z.object({
  id: z.string().default("tool_01KEXRJ81AB6VKSZ9EGNBQSQ5T"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
