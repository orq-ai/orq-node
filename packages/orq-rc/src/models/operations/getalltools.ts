...
export const Data3$inboundSchema: z.ZodType<Data3, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("tool_01JS1R5RHFPFSGZXZ1BE6KX6HX"),
    path: z.string(),
    key: z.string(),
    description: z.string(),
...
export const Data3$outboundSchema: z.ZodType<
  ...
  Data3
> = z.object({
  id: z.string().default("tool_01JS1R5RHFPFSGZXZ1BE6KX6HX"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const Data2$inboundSchema: z.ZodType<Data2, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("tool_01JS1R5RHETBS4W0765H13VFQ6"),
    path: z.string(),
    key: z.string(),
    description: z.string(),
    created_by_id: z.string().optional(),
...
export const Data2$outboundSchema: z.ZodType<
  ...
  Data2
> = z.object({
  id: z.string().default("tool_01JS1R5RHETBS4W0765H13VFQ6"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
...
export const Data1$inboundSchema: z.ZodType<Data1, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("tool_01JS1R5RHD72QH1V16EPATJ54Z"),
    path: z.string(),
    key: z.string(),
    description: z.string(),
    created_by_id: z.string().optional(),
...
export const Data1$outboundSchema: z.ZodType<
  ...
  Data1
> = z.object({
  id: z.string().default("tool_01JS1R5RHD72QH1V16EPATJ54Z"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
