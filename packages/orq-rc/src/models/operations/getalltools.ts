...
export const Data5$inboundSchema: z.ZodType<Data5, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K836P765PTGV1XZH58S570C0"),
    path: z.string(),
    key: z.string(),
...
export const Data5$outboundSchema: z.ZodType<
  ...
  Data5
> = z.object({
  id: z.string().default("01K836P765PTGV1XZH58S570C0"),
  path: z.string(),
  key: z.string(),
...
export const Data4$inboundSchema: z.ZodType<Data4, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K836P764JQQ0J2TJ8HZC4087"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data4$outboundSchema: z.ZodType<
  ...
  Data4
> = z.object({
  id: z.string().default("01K836P764JQQ0J2TJ8HZC4087"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const Data3$inboundSchema: z.ZodType<Data3, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K836P763YNVP0XQ1T6AZT8QF"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data3$outboundSchema: z.ZodType<
  ...
  Data3
> = z.object({
  id: z.string().default("01K836P763YNVP0XQ1T6AZT8QF"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K836P75WYXT92SN5JNQT0CW9"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData2$outboundSchema: z.ZodType<
  ...
  GetAllToolsData2
> = z.object({
  id: z.string().default("01K836P75WYXT92SN5JNQT0CW9"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K836P75WA1AMQ597N4SB8FFZ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData1$outboundSchema: z.ZodType<
  ...
  GetAllToolsData1
> = z.object({
  id: z.string().default("01K836P75WA1AMQ597N4SB8FFZ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
