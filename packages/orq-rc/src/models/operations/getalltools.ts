...
export const Data5$inboundSchema: z.ZodType<Data5, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K80129DPHF8RDDF3KY36ZC21"),
    path: z.string(),
    key: z.string(),
...
export const Data5$outboundSchema: z.ZodType<
  ...
  Data5
> = z.object({
  id: z.string().default("01K80129DPHF8RDDF3KY36ZC21"),
  path: z.string(),
  key: z.string(),
...
export const Data4$inboundSchema: z.ZodType<Data4, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K80129DPE8PG89X0ZZE9TG7P"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data4$outboundSchema: z.ZodType<
  ...
  Data4
> = z.object({
  id: z.string().default("01K80129DPE8PG89X0ZZE9TG7P"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const Data3$inboundSchema: z.ZodType<Data3, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K80129DNBF4WKV2QFG1QYZE8"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data3$outboundSchema: z.ZodType<
  ...
  Data3
> = z.object({
  id: z.string().default("01K80129DNBF4WKV2QFG1QYZE8"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K80129DMRQAFDCYDXTFXSBCY"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData2$outboundSchema: z.ZodType<
  ...
  GetAllToolsData2
> = z.object({
  id: z.string().default("01K80129DMRQAFDCYDXTFXSBCY"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K80129DMVS2WXRMV16GQVHZH"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const GetAllToolsData1$outboundSchema: z.ZodType<
  ...
  GetAllToolsData1
> = z.object({
  id: z.string().default("01K80129DMVS2WXRMV16GQVHZH"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
