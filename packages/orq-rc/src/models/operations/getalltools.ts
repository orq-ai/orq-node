...
export const DataCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KFCTAT3ZMTH2VEHBMD8W9Q6T"),
  path: z.string(),
  key: z.string(),
...
export const DataCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  DataCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KFCTAT3ZMTH2VEHBMD8W9Q6T"),
  path: z.string(),
  key: z.string(),
...
export const DataTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KFCTAT3XSYWPGYRY539QBP39"),
  name: z.string(),
...
export const DataMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KFCTAT3PQDP2DSK1H46S1DDZ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataMCPTool$outboundSchema: z.ZodType<
  ...
  DataMCPTool
> = z.object({
  id: z.string().default("tool_01KFCTAT3PQDP2DSK1H46S1DDZ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KFCTAT3EN64VR6BGX22E7Z4T"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$outboundSchema: z.ZodType<
  ...
  DataHTTPTool
> = z.object({
  id: z.string().default("tool_01KFCTAT3EN64VR6BGX22E7Z4T"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KFCTAT37WTNJQXXZKV2YYFRZ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  DataJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KFCTAT37WTNJQXXZKV2YYFRZ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KFCTAT31WF8P90Y15E0BP85B"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$outboundSchema: z.ZodType<
  ...
  DataFunctionTool
> = z.object({
  id: z.string().default("tool_01KFCTAT31WF8P90Y15E0BP85B"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
