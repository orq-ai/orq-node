...
export const DataCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF2RJ68D3ZR50JQJ5Z6KW8H7"),
  path: z.string(),
  key: z.string(),
...
export const DataCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  DataCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KF2RJ68D3ZR50JQJ5Z6KW8H7"),
  path: z.string(),
  key: z.string(),
...
export const DataTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KF2RJ68C179SR9KHWDHN3PZX"),
  name: z.string(),
...
export const DataMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF2RJ68BB72B3AW4C3EKWESX"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataMCPTool$outboundSchema: z.ZodType<
  ...
  DataMCPTool
> = z.object({
  id: z.string().default("tool_01KF2RJ68BB72B3AW4C3EKWESX"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF2RJ689RWR8YMJWNAZA2PM9"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$outboundSchema: z.ZodType<
  ...
  DataHTTPTool
> = z.object({
  id: z.string().default("tool_01KF2RJ689RWR8YMJWNAZA2PM9"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF2RJ687EKMX01VG1X34X43P"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  DataJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KF2RJ687EKMX01VG1X34X43P"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF2RJ68626WQWBD12Z3MQM93"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$outboundSchema: z.ZodType<
  ...
  DataFunctionTool
> = z.object({
  id: z.string().default("tool_01KF2RJ68626WQWBD12Z3MQM93"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
