...
export const Data5$inboundSchema: z.ZodType<Data5, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K7M9PT5K7JNNBQ2WFMB7WTQV"),
    path: z.string(),
    key: z.string(),
...
export const Data5$outboundSchema: z.ZodType<
  ...
  Data5
> = z.object({
  id: z.string().default("01K7M9PT5K7JNNBQ2WFMB7WTQV"),
  path: z.string(),
  key: z.string(),
...
export const Data4$inboundSchema: z.ZodType<Data4, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K7M9PT5KA9121VWY4E5C1NKS"),
    path: z.string(),
    key: z.string(),
    display_name: z.string(),
    description: z.string(),
...
export const Data4$outboundSchema: z.ZodType<
  ...
  Data4
> = z.object({
  id: z.string().default("01K7M9PT5KA9121VWY4E5C1NKS"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const Data3$inboundSchema: z.ZodType<Data3, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K7M9PT5J6QNGQ24ST25E9C6H"),
    path: z.string(),
    key: z.string(),
    display_name: z.string(),
    description: z.string(),
...
export const Data3$outboundSchema: z.ZodType<
  ...
  Data3
> = z.object({
  id: z.string().default("01K7M9PT5J6QNGQ24ST25E9C6H"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const GetAllToolsData2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7M9PT5JHX2XC4V1BF1K2BJS"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const GetAllToolsData2$outboundSchema: z.ZodType<
  ...
  GetAllToolsData2
> = z.object({
  id: z.string().default("01K7M9PT5JHX2XC4V1BF1K2BJS"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const GetAllToolsData1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7M9PT5HEX2ZWEPVK27AR9J7"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const GetAllToolsData1$outboundSchema: z.ZodType<
  ...
  GetAllToolsData1
> = z.object({
  id: z.string().default("01K7M9PT5HEX2ZWEPVK27AR9J7"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
