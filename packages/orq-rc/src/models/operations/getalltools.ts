...
export const Data5$inboundSchema: z.ZodType<Data5, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K6MDVPTCV6WSNH238RJ0AEJS"),
    path: z.string(),
    key: z.string(),
...
export const Data5$outboundSchema: z.ZodType<
  ...
  Data5
> = z.object({
  id: z.string().default("01K6MDVPTCV6WSNH238RJ0AEJS"),
  path: z.string(),
  key: z.string(),
...
export const Data4$inboundSchema: z.ZodType<Data4, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K6MDVPTC8XCY0ZC8FMMSJKCQ"),
    path: z.string(),
    key: z.string(),
    display_name: z.string(),
    description: z.string(),
...
export const Data4$outboundSchema: z.ZodType<
  ...
  Data4
> = z.object({
  id: z.string().default("01K6MDVPTC8XCY0ZC8FMMSJKCQ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const Data3$inboundSchema: z.ZodType<Data3, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K6MDVPTBTKHCXNZGPNVZ3GVN"),
    path: z.string(),
    key: z.string(),
    display_name: z.string(),
    description: z.string(),
...
export const Data3$outboundSchema: z.ZodType<
  ...
  Data3
> = z.object({
  id: z.string().default("01K6MDVPTBTKHCXNZGPNVZ3GVN"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const Data2$inboundSchema: z.ZodType<Data2, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K6MDVPTBW48AWN0NVQ3HRMC8"),
    path: z.string(),
    key: z.string(),
    display_name: z.string(),
    description: z.string(),
...
export const Data2$outboundSchema: z.ZodType<
  ...
  Data2
> = z.object({
  id: z.string().default("01K6MDVPTBW48AWN0NVQ3HRMC8"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const Data1$inboundSchema: z.ZodType<Data1, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K6MDVPTBXQKDESWHTWFHMYAP"),
    path: z.string(),
    key: z.string(),
    display_name: z.string(),
    description: z.string(),
...
export const Data1$outboundSchema: z.ZodType<
  ...
  Data1
> = z.object({
  id: z.string().default("01K6MDVPTBXQKDESWHTWFHMYAP"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
