...
export const Data5$inboundSchema: z.ZodType<Data5, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K8JXT2GSCA0J8YH9GPBWHEGA"),
    path: z.string(),
    key: z.string(),
...
export const Data5$outboundSchema: z.ZodType<
  ...
  Data5
> = z.object({
  id: z.string().default("01K8JXT2GSCA0J8YH9GPBWHEGA"),
  path: z.string(),
  key: z.string(),
...
export const Data4$inboundSchema: z.ZodType<Data4, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K8JXT2GPDTGJRWNPG2TBQKDK"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data4$outboundSchema: z.ZodType<
  ...
  Data4
> = z.object({
  id: z.string().default("01K8JXT2GPDTGJRWNPG2TBQKDK"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const Data3$inboundSchema: z.ZodType<Data3, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K8JXT2GKP4NDD517A8B1C3ZP"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data3$outboundSchema: z.ZodType<
  ...
  Data3
> = z.object({
  id: z.string().default("01K8JXT2GKP4NDD517A8B1C3ZP"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const Data2$inboundSchema: z.ZodType<Data2, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K8JXT2GH3RJK1S1SM18R92SH"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data2$outboundSchema: z.ZodType<
  ...
  Data2
> = z.object({
  id: z.string().default("01K8JXT2GH3RJK1S1SM18R92SH"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const Data1$inboundSchema: z.ZodType<Data1, z.ZodTypeDef, unknown> = z
  .object({
    _id: z.string().default("01K8JXT2GET28YS7V4R07T6GPR"),
    path: z.string(),
    key: z.string(),
    display_name: z.string().optional(),
    description: z.string(),
...
export const Data1$outboundSchema: z.ZodType<
  ...
  Data1
> = z.object({
  id: z.string().default("01K8JXT2GET28YS7V4R07T6GPR"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
