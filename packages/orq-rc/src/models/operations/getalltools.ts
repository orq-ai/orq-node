...
export const DataCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAJHH19T3A40QEQKYM9V40Z5"),
  path: z.string(),
  key: z.string(),
...
export const DataCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  DataCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KAJHH19T3A40QEQKYM9V40Z5"),
  path: z.string(),
  key: z.string(),
...
export const DataTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KAJHH19S7N4YSW83JXWWRJZ4"),
  name: z.string(),
...
export const DataMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAJHH19R47Q3FMA25ASTYT4H"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataMCPTool$outboundSchema: z.ZodType<
  ...
  DataMCPTool
> = z.object({
  id: z.string().default("tool_01KAJHH19R47Q3FMA25ASTYT4H"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAJHH19NMFNXT4ZK6MJ8MTV4"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataHTTPTool$outboundSchema: z.ZodType<
  ...
  DataHTTPTool
> = z.object({
  id: z.string().default("tool_01KAJHH19NMFNXT4ZK6MJ8MTV4"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAJHH19KF7KWFA7D36H2MA9V"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  DataJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KAJHH19KF7KWFA7D36H2MA9V"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAJHH19H3TXKJ64Y85W11HGZ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DataFunctionTool$outboundSchema: z.ZodType<
  ...
  DataFunctionTool
> = z.object({
  id: z.string().default("tool_01KAJHH19H3TXKJ64Y85W11HGZ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
