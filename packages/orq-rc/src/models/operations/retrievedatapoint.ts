...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-20T12:00:38.987Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-20T12:00:38.983Z"))
    .transform(v => v.toISOString()),
