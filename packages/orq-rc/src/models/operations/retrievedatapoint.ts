...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T06:27:19.250Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T06:27:19.249Z"))
    .transform(v => v.toISOString()),
