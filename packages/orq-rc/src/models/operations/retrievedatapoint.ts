...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.114Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.113Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.112Z"))
    .transform(v => v.toISOString()),
