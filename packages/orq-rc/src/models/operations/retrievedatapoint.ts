...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.077Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.076Z"))
    .transform(v => v.toISOString()),
