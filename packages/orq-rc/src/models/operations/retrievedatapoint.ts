...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:22:51.970Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:22:51.969Z"))
    .transform(v => v.toISOString()),
