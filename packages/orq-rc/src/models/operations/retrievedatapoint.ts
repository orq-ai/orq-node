...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.933Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.932Z"))
    .transform(v => v.toISOString()),
