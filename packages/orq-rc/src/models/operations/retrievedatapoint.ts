...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.023Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.022Z"))
    .transform(v => v.toISOString()),
