...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T10:29:56.975Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T10:29:56.974Z"))
    .transform(v => v.toISOString()),
