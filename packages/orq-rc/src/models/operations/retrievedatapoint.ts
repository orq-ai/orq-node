...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-16T14:53:50.196Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-16T14:53:50.195Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-16T14:53:50.194Z"))
    .transform(v => v.toISOString()),
