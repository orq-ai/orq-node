...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T14:28:52.010Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T14:28:52.009Z"))
    .transform(v => v.toISOString()),
