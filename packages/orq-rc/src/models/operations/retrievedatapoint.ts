...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.645Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.644Z"))
    .transform(v => v.toISOString()),
