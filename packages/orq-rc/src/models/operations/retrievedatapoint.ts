...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T06:10:48.303Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T06:10:48.302Z"))
    .transform(v => v.toISOString()),
