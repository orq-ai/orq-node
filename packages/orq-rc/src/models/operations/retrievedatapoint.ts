...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T12:57:59.292Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T12:57:59.291Z"))
    .transform(v => v.toISOString()),
