...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:03:20.982Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:03:20.981Z"))
    .transform(v => v.toISOString()),
