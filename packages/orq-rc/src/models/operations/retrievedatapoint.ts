...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-21T12:55:48.216Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-21T12:55:48.215Z"))
    .transform(v => v.toISOString()),
