...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T04:37:57.923Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T04:37:57.922Z"))
    .transform(v => v.toISOString()),
