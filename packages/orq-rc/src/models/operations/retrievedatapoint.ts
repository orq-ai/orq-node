...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T09:59:24.116Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T09:59:24.115Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T09:59:24.114Z"))
    .transform(v => v.toISOString()),
