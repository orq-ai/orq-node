...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T04:58:57.097Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T04:58:57.096Z"))
    .transform(v => v.toISOString()),
