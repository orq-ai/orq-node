...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T07:33:30.330Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T07:33:30.329Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T07:33:30.328Z"))
    .transform(v => v.toISOString()),
