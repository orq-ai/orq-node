...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-07T04:32:55.745Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-07T04:32:55.744Z"))
    .transform(v => v.toISOString()),
