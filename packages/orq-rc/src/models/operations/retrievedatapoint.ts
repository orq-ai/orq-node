...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:21:16.883Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:21:16.882Z"))
    .transform(v => v.toISOString()),
