...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.834Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.830Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.829Z"))
    .transform(v => v.toISOString()),
