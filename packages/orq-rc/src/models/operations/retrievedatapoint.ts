...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T16:34:51.478Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T16:34:51.477Z"))
    .transform(v => v.toISOString()),
