...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.751Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.750Z"))
    .transform(v => v.toISOString()),
