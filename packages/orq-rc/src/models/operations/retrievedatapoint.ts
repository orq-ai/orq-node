...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-15T12:57:30.237Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-15T12:57:30.236Z"))
    .transform(v => v.toISOString()),
