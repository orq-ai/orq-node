...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-17T05:54:21.020Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-17T05:54:21.019Z"))
    .transform(v => v.toISOString()),
