...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:42:55.725Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:42:55.724Z"))
    .transform(v => v.toISOString()),
