...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T06:52:50.414Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T06:52:50.413Z"))
    .transform(v => v.toISOString()),
