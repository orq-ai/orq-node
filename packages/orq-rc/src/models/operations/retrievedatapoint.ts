...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.317Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.316Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.313Z"))
    .transform(v => v.toISOString()),
