...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-25T11:11:30.578Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-25T11:11:30.577Z"))
    .transform(v => v.toISOString()),
