...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-22T05:15:34.731Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-22T05:15:34.730Z"))
    .transform(v => v.toISOString()),
