...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T10:28:50.425Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T10:28:50.424Z"))
    .transform(v => v.toISOString()),
