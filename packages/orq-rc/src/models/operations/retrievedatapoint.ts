...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.565Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.564Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.563Z"))
    .transform(v => v.toISOString()),
