...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T07:50:27.177Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T07:50:27.176Z"))
    .transform(v => v.toISOString()),
