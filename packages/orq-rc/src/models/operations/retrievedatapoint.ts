...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.357Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.356Z"))
    .transform(v => v.toISOString()),
