...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.752Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.744Z"))
    .transform(v => v.toISOString()),
