...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.451Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.448Z"))
    .transform(v => v.toISOString()),
