...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.519Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.518Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.517Z"))
    .transform(v => v.toISOString()),
