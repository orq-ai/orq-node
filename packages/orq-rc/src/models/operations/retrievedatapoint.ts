...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T17:33:44.515Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T17:33:44.514Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T17:33:44.513Z"))
    .transform(v => v.toISOString()),
