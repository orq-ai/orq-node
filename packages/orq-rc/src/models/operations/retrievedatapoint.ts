...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T09:18:56.122Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T09:18:56.121Z"))
    .transform(v => v.toISOString()),
