...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.970Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.969Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.968Z"))
    .transform(v => v.toISOString()),
