...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T08:19:31.019Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T08:19:31.018Z"))
    .transform(v => v.toISOString()),
