...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.780Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.779Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.778Z"))
    .transform(v => v.toISOString()),
