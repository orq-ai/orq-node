...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T12:58:56.718Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T12:58:56.717Z"))
    .transform(v => v.toISOString()),
