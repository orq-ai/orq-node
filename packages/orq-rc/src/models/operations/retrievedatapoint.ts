...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.218Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.217Z"))
    .transform(v => v.toISOString()),
