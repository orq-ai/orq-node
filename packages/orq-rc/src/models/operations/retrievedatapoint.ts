...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-08T21:45:02.614Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-08T21:45:02.613Z"))
    .transform(v => v.toISOString()),
