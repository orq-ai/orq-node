...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.711Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.710Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.709Z"))
    .transform(v => v.toISOString()),
