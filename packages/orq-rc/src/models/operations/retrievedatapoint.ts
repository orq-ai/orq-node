...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T15:06:57.368Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T15:06:57.367Z"))
    .transform(v => v.toISOString()),
