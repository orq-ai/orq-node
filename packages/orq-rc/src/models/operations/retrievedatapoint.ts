...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T10:42:46.795Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T10:42:46.794Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T10:42:46.791Z"))
    .transform(v => v.toISOString()),
