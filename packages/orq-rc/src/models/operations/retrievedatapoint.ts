...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T09:05:00.231Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T09:05:00.230Z"))
    .transform(v => v.toISOString()),
