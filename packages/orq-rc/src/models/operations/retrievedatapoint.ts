...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T13:19:57.131Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T13:19:57.130Z"))
    .transform(v => v.toISOString()),
