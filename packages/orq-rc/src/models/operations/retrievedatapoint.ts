...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T13:04:28.700Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T13:04:28.699Z"))
    .transform(v => v.toISOString()),
