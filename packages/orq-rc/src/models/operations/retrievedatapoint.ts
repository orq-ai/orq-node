...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.568Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.567Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.566Z"))
    .transform(v => v.toISOString()),
