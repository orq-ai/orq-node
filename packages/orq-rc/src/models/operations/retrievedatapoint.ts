...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.143Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.142Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.141Z"))
    .transform(v => v.toISOString()),
