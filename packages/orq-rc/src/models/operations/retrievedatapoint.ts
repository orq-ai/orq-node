...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.958Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.957Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.948Z"))
    .transform(v => v.toISOString()),
