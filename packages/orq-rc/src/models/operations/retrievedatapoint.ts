...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-28T12:16:22.792Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-28T12:16:22.791Z"))
    .transform(v => v.toISOString()),
