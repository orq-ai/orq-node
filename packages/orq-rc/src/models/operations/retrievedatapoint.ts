...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-01-17T09:51:07.827Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2026-01-17T09:51:07.826Z"))
    .transform(v => v.toISOString()),
  type: z.literal("number"),
  value: z.number(),
}).transform((v) => {
