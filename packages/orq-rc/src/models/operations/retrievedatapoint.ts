...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T07:47:16.842Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T07:47:16.841Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T07:47:16.836Z"))
    .transform(v => v.toISOString()),
