...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T04:24:17.610Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T04:24:17.609Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T04:24:17.608Z"))
    .transform(v => v.toISOString()),
