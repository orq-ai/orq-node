...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-24T09:48:43.408Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-24T09:48:43.407Z"))
    .transform(v => v.toISOString()),
