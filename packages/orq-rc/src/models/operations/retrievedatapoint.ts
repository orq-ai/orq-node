...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T09:41:08.830Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T09:41:08.829Z"))
    .transform(v => v.toISOString()),
