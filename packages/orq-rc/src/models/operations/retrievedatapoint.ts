...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T04:09:14.324Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T04:09:14.323Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T04:09:14.322Z"))
    .transform(v => v.toISOString()),
