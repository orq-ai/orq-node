...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-01-20T13:00:33.360Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2026-01-20T13:00:33.359Z"))
    .transform(v => v.toISOString()),
  type: z.literal("string"),
  value: z.string(),
}).transform((v) => {
