...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T05:44:59.140Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T05:44:59.139Z"))
    .transform(v => v.toISOString()),
