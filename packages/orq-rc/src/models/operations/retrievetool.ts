...
export const RetrieveToolResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KJCYYPBQB1CJ0S307T9Z0C80"),
  path: z.string(),
  key: z.string(),
...
export const RetrieveToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KJCYYPBP74MERNZ49168RSQM"),
  name: z.string(),
...
export const RetrieveToolResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KJCYYPBNEYAWXDQRX8C9N14H"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const RetrieveToolResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KJCYYPBMRKSY0MHCNNMX2ATA"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const RetrieveToolResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KJCYYPBHQB0SX7X1684T2WWX"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const RetrieveToolResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KJCYYPBFHXR7TKBFV26MR4B4"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
