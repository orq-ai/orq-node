...
export const RetrieveToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JS1R5RHQMMXEV6ASDB2FW3NP"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const RetrieveToolResponseBody3$outboundSchema: z.ZodType<
  ...
  RetrieveToolResponseBody3
> = z.object({
  id: z.string().default("tool_01JS1R5RHQMMXEV6ASDB2FW3NP"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const RetrieveToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JS1R5RHQ1XDW9VWCF3DBP0GC"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  created_by_id: z.string().optional(),
...
export const RetrieveToolResponseBody2$outboundSchema: z.ZodType<
  ...
  RetrieveToolResponseBody2
> = z.object({
  id: z.string().default("tool_01JS1R5RHQ1XDW9VWCF3DBP0GC"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
...
export const RetrieveToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JS1R5RHPB3VTQEV2R9TRYCRS"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  created_by_id: z.string().optional(),
...
export const RetrieveToolResponseBody1$outboundSchema: z.ZodType<
  ...
  RetrieveToolResponseBody1
> = z.object({
  id: z.string().default("tool_01JS1R5RHPB3VTQEV2R9TRYCRS"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
