 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DeploymentStreamPrefixMessagesFunction$ {
  /** @deprecated use `DeploymentStreamPrefixMessagesFunction$inboundSchema` instead. */
  export const inboundSchema =
    DeploymentStreamPrefixMessagesFunction$inboundSchema;
  /** @deprecated use `DeploymentStreamPrefixMessagesFunction$outboundSchema` instead. */
  export const outboundSchema =
    DeploymentStreamPrefixMessagesFunction$outboundSchema;
  /** @deprecated use `DeploymentStreamPrefixMessagesFunction$Outbound` instead. */
  export type Outbound = DeploymentStreamPrefixMessagesFunction$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DeploymentStreamPrefixMessagesToolCalls$ {
  /** @deprecated use `DeploymentStreamPrefixMessagesToolCalls$inboundSchema` instead. */
  export const inboundSchema =
    DeploymentStreamPrefixMessagesToolCalls$inboundSchema;
  /** @deprecated use `DeploymentStreamPrefixMessagesToolCalls$outboundSchema` instead. */
  export const outboundSchema =
    DeploymentStreamPrefixMessagesToolCalls$outboundSchema;
  /** @deprecated use `DeploymentStreamPrefixMessagesToolCalls$Outbound` instead. */
  export type Outbound = DeploymentStreamPrefixMessagesToolCalls$Outbound;
}
