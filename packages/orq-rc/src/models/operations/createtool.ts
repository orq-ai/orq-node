...
export const ResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K94HF0B32BEFQ4CMJDHX9GKW"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody5$outboundSchema: z.ZodType<
  ...
  ResponseBody5
> = z.object({
  id: z.string().default("01K94HF0B32BEFQ4CMJDHX9GKW"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K94HF0B0TPF61H9AEWMRMFAD"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$outboundSchema: z.ZodType<
  ...
  ResponseBody4
> = z.object({
  id: z.string().default("01K94HF0B0TPF61H9AEWMRMFAD"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K94HF0AXT5NBFBYAQ9TSKVXT"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$outboundSchema: z.ZodType<
  ...
  ResponseBody3
> = z.object({
  id: z.string().default("01K94HF0AXT5NBFBYAQ9TSKVXT"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K94HF0AVYGQWMB46CE45ADJD"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$outboundSchema: z.ZodType<
  ...
  ResponseBody2
> = z.object({
  id: z.string().default("01K94HF0AVYGQWMB46CE45ADJD"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K94HF0ATM8HBAEX6Z07XVR0T"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$outboundSchema: z.ZodType<
  ...
  ResponseBody1
> = z.object({
  id: z.string().default("01K94HF0ATM8HBAEX6Z07XVR0T"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
