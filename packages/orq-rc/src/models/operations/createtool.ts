 ...
 */
export const CreateToolRequestBodyToolsRequest4CodeToolType = {
  Object: "object",
} as const;
/**
 * The type must be "object"
 */
export type CreateToolRequestBodyToolsRequest4CodeToolType = ClosedEnum<
  typeof CreateToolRequestBodyToolsRequest4CodeToolType
>;
...
/** @internal */
export const CreateToolRequestBodyToolsRequest4CodeToolType$outboundSchema:
  z.ZodNativeEnum<typeof CreateToolRequestBodyToolsRequest4CodeToolType> = z
    .nativeEnum(CreateToolRequestBodyToolsRequest4CodeToolType);
...
> = z.object({
  type: CreateToolRequestBodyToolsRequest4CodeToolType$outboundSchema,
...
export const ResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01M0T3FQ8FR4F00DBX1R5DSXBT"),
  path: z.string(),
  key: z.string(),
...
export const ResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01M0T3FQ893F51S0P6VQSJRQP9"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01M0T3FQ88QT0VJ5XHX4SAPHBT"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01M0T3FQ87DYFC1WAWBRR6XXE3"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
