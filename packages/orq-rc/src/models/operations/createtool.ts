...
export const ResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAGFMWRCMAX6KXJ37K66M79T"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody5$outboundSchema: z.ZodType<
  ...
  ResponseBody5
> = z.object({
  id: z.string().default("tool_01KAGFMWRCMAX6KXJ37K66M79T"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KAGFMWRB7C6TMWNHPA9F9FK1"),
  name: z.string(),
  description: z.string().optional(),
...
export const ResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAGFMWR9RCRSKGQAJG23HTJ6"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody4$outboundSchema: z.ZodType<
  ...
  ResponseBody4
> = z.object({
  id: z.string().default("tool_01KAGFMWR9RCRSKGQAJG23HTJ6"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAGFMWR6510E24GDCSXK9M4W"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody3$outboundSchema: z.ZodType<
  ...
  ResponseBody3
> = z.object({
  id: z.string().default("tool_01KAGFMWR6510E24GDCSXK9M4W"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAGFMWQW61Y3TD1QTRD4GFKQ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody2$outboundSchema: z.ZodType<
  ...
  ResponseBody2
> = z.object({
  id: z.string().default("tool_01KAGFMWQW61Y3TD1QTRD4GFKQ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KAGFMWQTH7MQXG1GF3QKR024"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBody1$outboundSchema: z.ZodType<
  ...
  ResponseBody1
> = z.object({
  id: z.string().default("tool_01KAGFMWQTH7MQXG1GF3QKR024"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
