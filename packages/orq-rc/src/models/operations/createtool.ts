...
export const ResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JRZ5JNF19MWC4ZB2WZ58169N"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const ResponseBody3$outboundSchema: z.ZodType<
  ...
  ResponseBody3
> = z.object({
  id: z.string().default("tool_01JRZ5JNF19MWC4ZB2WZ58169N"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const ResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JRZ5JNF10WNSRD0684WX4WPN"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  created_by_id: z.string().optional(),
...
export const ResponseBody2$outboundSchema: z.ZodType<
  ...
  ResponseBody2
> = z.object({
  id: z.string().default("tool_01JRZ5JNF10WNSRD0684WX4WPN"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
...
export const ResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JRZ5JNF15T93YPPNJ7K0K0E7"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  created_by_id: z.string().optional(),
...
export const ResponseBody1$outboundSchema: z.ZodType<
  ...
  ResponseBody1
> = z.object({
  id: z.string().default("tool_01JRZ5JNF15T93YPPNJ7K0K0E7"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
