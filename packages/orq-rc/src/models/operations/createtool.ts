...
export const ResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KC0320KVGG0FJE72ADS6R2WJ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  ResponseBodyCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KC0320KVGG0FJE72ADS6R2WJ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KC0320KTWB5BBZ80XYJH5MSC"),
  name: z.string(),
  description: z.string().optional(),
...
export const ResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KC0320KR531B46XEXPF58RQ3"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyMCPTool$outboundSchema: z.ZodType<
  ...
  ResponseBodyMCPTool
> = z.object({
  id: z.string().default("tool_01KC0320KR531B46XEXPF58RQ3"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KC0320KN5XDABGXAGT50QQVN"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyHTTPTool$outboundSchema: z.ZodType<
  ...
  ResponseBodyHTTPTool
> = z.object({
  id: z.string().default("tool_01KC0320KN5XDABGXAGT50QQVN"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KC0320KKAH370244VJKH0X2Y"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  ResponseBodyJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KC0320KKAH370244VJKH0X2Y"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KC0320KGSYNF0AMT792MHZKH"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const ResponseBodyFunctionTool$outboundSchema: z.ZodType<
  ...
  ResponseBodyFunctionTool
> = z.object({
  id: z.string().default("tool_01KC0320KGSYNF0AMT792MHZKH"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
