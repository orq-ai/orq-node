...
export const DuplicateToolResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KABAYFYN29VA2VX30PZ5G11Z"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody5$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody5
> = z.object({
  id: z.string().default("tool_01KABAYFYN29VA2VX30PZ5G11Z"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KABAYFYMV0NCGDD4EM1NWJ7G"),
  name: z.string(),
...
export const DuplicateToolResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KABAYFYKXVMRYBBKXXGC6DN0"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody4$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody4
> = z.object({
  id: z.string().default("tool_01KABAYFYKXVMRYBBKXXGC6DN0"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KABAYFYHRS6JHAR63T5CZ0GH"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody3
> = z.object({
  id: z.string().default("tool_01KABAYFYHRS6JHAR63T5CZ0GH"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KABAYFYG896ZS9JBZ6E2V5JT"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody2
> = z.object({
  id: z.string().default("tool_01KABAYFYG896ZS9JBZ6E2V5JT"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KABAYFYEPEEP6QH2HDC5FG63"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const DuplicateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody1
> = z.object({
  id: z.string().default("tool_01KABAYFYEPEEP6QH2HDC5FG63"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
