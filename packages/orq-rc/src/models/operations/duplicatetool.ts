...
export const DuplicateToolResponseBody5$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7EMQCR5A05T3G9M68QM4HXE"),
  path: z.string(),
  key: z.string(),
...
export const DuplicateToolResponseBody5$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody5
> = z.object({
  id: z.string().default("01K7EMQCR5A05T3G9M68QM4HXE"),
  path: z.string(),
  key: z.string(),
...
export const DuplicateToolResponseBody4$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7EMQCR5K172NRYJSW1B8P2R"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody4$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody4
> = z.object({
  id: z.string().default("01K7EMQCR5K172NRYJSW1B8P2R"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7EMQCR4NMEZZPKNH459A3C0"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody3
> = z.object({
  id: z.string().default("01K7EMQCR4NMEZZPKNH459A3C0"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7EMQCR4K6JRF88FW3CPYVJ4"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody2
> = z.object({
  id: z.string().default("01K7EMQCR4K6JRF88FW3CPYVJ4"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("01K7EMQCR4V66H14V6QXY7C7NT"),
  path: z.string(),
  key: z.string(),
  display_name: z.string(),
  description: z.string(),
...
export const DuplicateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  DuplicateToolResponseBody1
> = z.object({
  id: z.string().default("01K7EMQCR4V66H14V6QXY7C7NT"),
  path: z.string(),
  key: z.string(),
  displayName: z.string(),
  description: z.string(),
