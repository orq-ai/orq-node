...
export const PartReasoningPart$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("reasoning_01kerte09x94xmja1zpv4j342f"),
...
export const PartReasoningPart$outboundSchema: z.ZodType<
  ...
  PartReasoningPart
> = z.object({
  id: z.string().default("reasoning_01kerte09x94xmja1zpv4j342f"),
  metadata: z.record(z.any()).optional(),
...
export const ReasoningPart$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("reasoning_01kerte09rssvw95e7530wvhzd"),
  metadata: z.record(z.any()).optional(),
...
export const ReasoningPart$outboundSchema: z.ZodType<
  ...
  ReasoningPart
> = z.object({
  id: z.string().default("reasoning_01kerte09rssvw95e7530wvhzd"),
  metadata: z.record(z.any()).optional(),
