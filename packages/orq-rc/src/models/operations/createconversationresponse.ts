...
export const PartReasoningPart$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("reasoning_01kf1769hmq5rtk6rqwb9mmgze"),
...
export const PartReasoningPart$outboundSchema: z.ZodType<
  ...
  PartReasoningPart
> = z.object({
  id: z.string().default("reasoning_01kf1769hmq5rtk6rqwb9mmgze"),
  metadata: z.record(z.any()).optional(),
...
export const ReasoningPart$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("reasoning_01kf1769hht9pw601rh7gsbj3t"),
  metadata: z.record(z.any()).optional(),
...
export const ReasoningPart$outboundSchema: z.ZodType<
  ...
  ReasoningPart
> = z.object({
  id: z.string().default("reasoning_01kf1769hht9pw601rh7gsbj3t"),
  metadata: z.record(z.any()).optional(),
