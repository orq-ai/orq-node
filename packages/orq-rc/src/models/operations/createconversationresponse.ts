...
export const PartReasoningPart$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("reasoning_01kf08b1jfsr1dz52ymqd9r7pb"),
...
export const PartReasoningPart$outboundSchema: z.ZodType<
  ...
  PartReasoningPart
> = z.object({
  id: z.string().default("reasoning_01kf08b1jfsr1dz52ymqd9r7pb"),
  metadata: z.record(z.any()).optional(),
...
export const ReasoningPart$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("reasoning_01kf08b1j3ky4kjsg2m5cwt41f"),
  metadata: z.record(z.any()).optional(),
...
export const ReasoningPart$outboundSchema: z.ZodType<
  ...
  ReasoningPart
> = z.object({
  id: z.string().default("reasoning_01kf08b1j3ky4kjsg2m5cwt41f"),
  metadata: z.record(z.any()).optional(),
