...
export const RequestBodyTools$outboundSchema: z.ZodType<
  ...
  RequestBodyTools
> = z.object({
  id: z.string().default("01KY56KE4JKV4P7EA0VZ682686"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KY56KE3YP0PE20ZY6BFXTWKZ"),
  path: z.string(),
  key: z.string(),
...
export const UpdateToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KY56KE3WBNR7KK8VP0A45S65"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KY56KE3SK1KXJKNFH5C6N7AR"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KY56KE3M94XS768Y1N3G1YB5"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KY56KE3HPBTZGS6VW0ENHH78"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KY56KE3EVR3RSF6A89321PVH"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
