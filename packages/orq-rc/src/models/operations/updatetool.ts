...
export const RequestBodyTools$outboundSchema: z.ZodType<
  ...
  RequestBodyTools
> = z.object({
  id: z.string().default("01KH3PK00RM4VARS3JGNSWPX3W"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KH3PK00HWNHA9TDPJH70J747"),
  path: z.string(),
  key: z.string(),
...
export const UpdateToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KH3PK00HHJEYWF8NNV94WXBJ"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KH3PK00G7VJQ6520EFH0RHM6"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KH3PK00EPQGR48D89VX9WW5Z"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KH3PK00DS5FZE74CBXRMYA6Z"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KH3PK00BQHW4CQTYYR6773CR"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
