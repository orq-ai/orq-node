...
export const RequestBodyTools$outboundSchema: z.ZodType<
  ...
  RequestBodyTools
> = z.object({
  id: z.string().default("01KK9GG41KKSRH1Q9Z2748NJZE"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KK9GG41B4EPVDDC5SMJBWAPM"),
  path: z.string(),
  key: z.string(),
...
export const UpdateToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KK9GG41AQ2X8V5WGN82C9ATP"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KK9GG4183DBKKPF1NN0BFAAZ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KK9GG416RBV6YHBE3ZSRXEKP"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KK9GG414MXEDY2NNPHB2C5ZA"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KK9GG4124YSE319J9RZY23KN"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
