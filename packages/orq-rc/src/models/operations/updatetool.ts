...
export const RequestBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KF08B1V11M33KGEMZ5Z5X0DM"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyCodeExecutionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF08B1TVT720G8AE6JGR6Y0Q"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyCodeExecutionTool$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBodyCodeExecutionTool
> = z.object({
  id: z.string().default("tool_01KF08B1TVT720G8AE6JGR6Y0Q"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyTools$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  id: z.string().default("01KF08B1TTTYGTTMHG015CWQKQ"),
  name: z.string(),
  description: z.string().optional(),
...
export const UpdateToolResponseBodyMCPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF08B1TSSHDG4F7SKZ9Z86DR"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyMCPTool$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBodyMCPTool
> = z.object({
  id: z.string().default("tool_01KF08B1TSSHDG4F7SKZ9Z86DR"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyHTTPTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF08B1TP75G6A8Y2X2ZRG2K5"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyHTTPTool$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBodyHTTPTool
> = z.object({
  id: z.string().default("tool_01KF08B1TP75G6A8Y2X2ZRG2K5"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyJSONSchemaTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF08B1TM33ZTM001VA9KWEAJ"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyJSONSchemaTool$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBodyJSONSchemaTool
> = z.object({
  id: z.string().default("tool_01KF08B1TM33ZTM001VA9KWEAJ"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyFunctionTool$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01KF08B1TJJPNJGK7R0N312WRH"),
  path: z.string(),
  key: z.string(),
  display_name: z.string().optional(),
  description: z.string(),
...
export const UpdateToolResponseBodyFunctionTool$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBodyFunctionTool
> = z.object({
  id: z.string().default("tool_01KF08B1TJJPNJGK7R0N312WRH"),
  path: z.string(),
  key: z.string(),
  displayName: z.string().optional(),
  description: z.string(),
