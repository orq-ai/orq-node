...
export const UpdateToolResponseBody3$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JS405PM1T5XS3VFY5XVXVXC0"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody3$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody3
> = z.object({
  id: z.string().default("tool_01JS405PM1T5XS3VFY5XVXVXC0"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
...
export const UpdateToolResponseBody2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JS405PKZPDBM7DE9C59WSRQH"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  created_by_id: z.string().optional(),
...
export const UpdateToolResponseBody2$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody2
> = z.object({
  id: z.string().default("tool_01JS405PKZPDBM7DE9C59WSRQH"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
...
export const UpdateToolResponseBody1$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  _id: z.string().default("tool_01JS405PKYSTMFDSCSGMEMCM2W"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  created_by_id: z.string().optional(),
...
export const UpdateToolResponseBody1$outboundSchema: z.ZodType<
  ...
  UpdateToolResponseBody1
> = z.object({
  id: z.string().default("tool_01JS405PKYSTMFDSCSGMEMCM2W"),
  path: z.string(),
  key: z.string(),
  description: z.string(),
  createdById: z.string().optional(),
