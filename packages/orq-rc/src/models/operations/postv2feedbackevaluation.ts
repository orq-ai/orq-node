...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-11T05:07:09.910Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-11T05:07:09.909Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-11T05:07:09.908Z"))
    .transform(v => v.toISOString()),
