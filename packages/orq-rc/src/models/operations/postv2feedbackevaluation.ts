...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-04-21T12:26:52.761Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-04-21T12:26:52.760Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-04-21T12:26:52.759Z"))
    .transform(v => v.toISOString()),
