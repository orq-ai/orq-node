...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-08T12:34:58.629Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-08T12:34:58.628Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-08T12:34:58.627Z"))
    .transform(v => v.toISOString()),
