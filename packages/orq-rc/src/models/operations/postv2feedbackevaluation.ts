...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-30T10:46:55.074Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-30T10:46:55.073Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-30T10:46:55.072Z"))
    .transform(v => v.toISOString()),
