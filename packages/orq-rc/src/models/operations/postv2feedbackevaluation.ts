...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-16T09:29:22.195Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-16T09:29:22.194Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-16T09:29:22.193Z"))
    .transform(v => v.toISOString()),
