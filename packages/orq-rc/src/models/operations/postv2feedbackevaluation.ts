...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-24T14:42:58.515Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-24T14:42:58.514Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-24T14:42:58.513Z"))
    .transform(v => v.toISOString()),
