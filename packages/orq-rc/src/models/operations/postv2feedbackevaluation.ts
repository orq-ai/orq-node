...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-23T06:18:52.692Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-23T06:18:52.691Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-23T06:18:52.690Z"))
    .transform(v => v.toISOString()),
