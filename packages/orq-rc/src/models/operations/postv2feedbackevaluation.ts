...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-05-21T07:56:11.097Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-21T07:56:11.096Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-21T07:56:11.088Z"))
    .transform(v => v.toISOString()),
