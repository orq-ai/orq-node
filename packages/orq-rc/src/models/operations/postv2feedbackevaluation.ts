...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-06T08:50:43.162Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-06T08:50:43.153Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-06T08:50:43.152Z"))
    .transform(v => v.toISOString()),
