...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-01T12:26:30.426Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-01T12:26:30.425Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-01T12:26:30.424Z"))
    .transform(v => v.toISOString()),
