...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-29T13:50:14.203Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-29T13:50:14.202Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-29T13:50:14.201Z"))
    .transform(v => v.toISOString()),
