...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-01T12:58:32.110Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-01T12:58:32.109Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-01T12:58:32.108Z"))
    .transform(v => v.toISOString()),
