...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-10T11:26:28.002Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-10T11:26:28.001Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-10T11:26:28.000Z"))
    .transform(v => v.toISOString()),
