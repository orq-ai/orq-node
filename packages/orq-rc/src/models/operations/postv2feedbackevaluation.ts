...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-05-18T05:04:37.607Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-18T05:04:37.606Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-18T05:04:37.603Z"))
    .transform(v => v.toISOString()),
