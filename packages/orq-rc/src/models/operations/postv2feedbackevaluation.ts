...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-25T10:39:59.531Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T10:39:59.530Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T10:39:59.524Z"))
    .transform(v => v.toISOString()),
