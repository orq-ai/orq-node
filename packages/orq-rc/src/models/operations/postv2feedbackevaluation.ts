...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-03T16:57:03.533Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-03T16:57:03.532Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-03T16:57:03.531Z"))
    .transform(v => v.toISOString()),
