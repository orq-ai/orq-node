...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-22T05:54:42.299Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-22T05:54:42.298Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-22T05:54:42.297Z"))
    .transform(v => v.toISOString()),
