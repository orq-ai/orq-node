...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-15T13:36:43.646Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-15T13:36:43.645Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-15T13:36:43.644Z"))
    .transform(v => v.toISOString()),
