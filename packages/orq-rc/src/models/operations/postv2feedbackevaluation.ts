...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-30T08:15:46.262Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-30T08:15:46.261Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-30T08:15:46.260Z"))
    .transform(v => v.toISOString()),
