...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-05-11T08:28:34.674Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-11T08:28:34.672Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-11T08:28:34.670Z"))
    .transform(v => v.toISOString()),
