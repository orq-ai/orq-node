...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-19T08:56:52.667Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-19T08:56:52.666Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-19T08:56:52.665Z"))
    .transform(v => v.toISOString()),
