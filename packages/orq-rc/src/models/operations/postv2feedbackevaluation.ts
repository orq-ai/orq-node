...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-03T05:48:33.970Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-03T05:48:33.969Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-03T05:48:33.968Z"))
    .transform(v => v.toISOString()),
