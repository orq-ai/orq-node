...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-25T07:43:18.592Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-25T07:43:18.591Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-25T07:43:18.590Z"))
    .transform(v => v.toISOString()),
