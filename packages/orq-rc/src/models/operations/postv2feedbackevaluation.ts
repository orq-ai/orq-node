...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-20T03:51:27.430Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-20T03:51:27.429Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-20T03:51:27.428Z"))
    .transform(v => v.toISOString()),
