...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-20T15:21:05.565Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-20T15:21:05.564Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-20T15:21:05.563Z"))
    .transform(v => v.toISOString()),
