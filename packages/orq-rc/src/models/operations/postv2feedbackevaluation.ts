...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-04T09:24:19.886Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-04T09:24:19.885Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-04T09:24:19.884Z"))
    .transform(v => v.toISOString()),
