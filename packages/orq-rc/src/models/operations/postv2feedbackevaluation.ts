...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-11T09:48:43.330Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-11T09:48:43.329Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-11T09:48:43.328Z"))
    .transform(v => v.toISOString()),
