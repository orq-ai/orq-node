...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-25T06:35:01.127Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-25T06:35:01.126Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-25T06:35:01.125Z"))
    .transform(v => v.toISOString()),
