...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-06T10:55:06.103Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-06T10:55:06.102Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-06T10:55:06.101Z"))
    .transform(v => v.toISOString()),
