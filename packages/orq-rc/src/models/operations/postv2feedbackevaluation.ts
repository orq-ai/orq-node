...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-25T03:48:54.414Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T03:48:54.413Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T03:48:54.412Z"))
    .transform(v => v.toISOString()),
