...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-08T21:19:46.960Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-08T21:19:46.959Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-08T21:19:46.958Z"))
    .transform(v => v.toISOString()),
