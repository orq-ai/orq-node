...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-12T07:29:26.899Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-12T07:29:26.898Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-12T07:29:26.897Z"))
    .transform(v => v.toISOString()),
