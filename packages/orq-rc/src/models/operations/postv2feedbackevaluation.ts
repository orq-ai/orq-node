...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-06T07:28:55.869Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-06T07:28:55.868Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-06T07:28:55.867Z"))
    .transform(v => v.toISOString()),
