...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-16T09:24:29.349Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-16T09:24:29.348Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-16T09:24:29.347Z"))
    .transform(v => v.toISOString()),
