...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-15T13:29:44.536Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-15T13:29:44.535Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-15T13:29:44.534Z"))
    .transform(v => v.toISOString()),
