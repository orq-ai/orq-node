...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-05-31T08:28:27.326Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-31T08:28:27.325Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-31T08:28:27.324Z"))
    .transform(v => v.toISOString()),
