...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-24T15:35:26.097Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-24T15:35:26.096Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-24T15:35:26.095Z"))
    .transform(v => v.toISOString()),
