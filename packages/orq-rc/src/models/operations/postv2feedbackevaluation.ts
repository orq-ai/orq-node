...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-02T14:43:39.016Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-02T14:43:39.015Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-02T14:43:39.014Z"))
    .transform(v => v.toISOString()),
