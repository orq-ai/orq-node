...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-18T04:51:07.107Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-18T04:51:07.106Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-18T04:51:07.105Z"))
    .transform(v => v.toISOString()),
