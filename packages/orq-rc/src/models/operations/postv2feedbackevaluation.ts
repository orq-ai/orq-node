...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-07T13:42:40.254Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-07T13:42:40.253Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-07T13:42:40.252Z"))
    .transform(v => v.toISOString()),
