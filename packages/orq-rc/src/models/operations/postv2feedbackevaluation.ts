...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-25T08:05:24.162Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T08:05:24.161Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-25T08:05:24.160Z"))
    .transform(v => v.toISOString()),
