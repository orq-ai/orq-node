...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-24T03:24:54.227Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-24T03:24:54.226Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-24T03:24:54.225Z"))
    .transform(v => v.toISOString()),
