...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-20T15:40:13.656Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-20T15:40:13.655Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-20T15:40:13.654Z"))
    .transform(v => v.toISOString()),
