...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-04T12:20:15.178Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-04T12:20:15.177Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-04T12:20:15.176Z"))
    .transform(v => v.toISOString()),
