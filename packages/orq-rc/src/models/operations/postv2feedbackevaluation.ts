...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-05-20T05:21:18.608Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-20T05:21:18.605Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-20T05:21:18.604Z"))
    .transform(v => v.toISOString()),
