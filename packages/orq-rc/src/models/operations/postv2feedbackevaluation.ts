...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-06-01T13:49:21.418Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-01T13:49:21.417Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-01T13:49:21.416Z"))
    .transform(v => v.toISOString()),
