...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-26T10:43:48.297Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-26T10:43:48.296Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-26T10:43:48.295Z"))
    .transform(v => v.toISOString()),
