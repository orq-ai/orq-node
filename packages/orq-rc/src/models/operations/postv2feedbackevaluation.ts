...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-30T08:20:12.977Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-30T08:20:12.976Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-30T08:20:12.975Z"))
    .transform(v => v.toISOString()),
