...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-07T11:44:19.467Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-07T11:44:19.466Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-07T11:44:19.465Z"))
    .transform(v => v.toISOString()),
