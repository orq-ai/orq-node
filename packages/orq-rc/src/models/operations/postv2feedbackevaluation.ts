...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyRequestSource$outboundSchema
    .default("orq"),
  reviewedAt: z.date().default(() => new Date("2026-05-19T12:48:20.345Z"))
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-19T12:48:20.343Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-05-19T12:48:20.338Z"))
    .transform(v => v.toISOString()),
