...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-08-26T09:47:00.752Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-26T09:47:00.751Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-08-26T09:47:00.750Z"))
    .transform(v => v.toISOString()),
