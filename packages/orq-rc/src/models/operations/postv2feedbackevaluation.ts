...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-19T14:54:02.554Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-19T14:54:02.553Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-19T14:54:02.551Z"))
    .transform(v => v.toISOString()),
