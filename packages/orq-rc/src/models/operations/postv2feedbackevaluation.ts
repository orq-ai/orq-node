...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-22T11:38:26.333Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-22T11:38:26.332Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-22T11:38:26.331Z"))
    .transform(v => v.toISOString()),
