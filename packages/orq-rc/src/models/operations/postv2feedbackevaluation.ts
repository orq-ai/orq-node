...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-29T07:30:46.055Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-29T07:30:46.054Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-29T07:30:46.053Z"))
    .transform(v => v.toISOString()),
