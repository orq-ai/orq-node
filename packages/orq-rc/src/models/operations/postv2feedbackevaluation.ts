...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-07-17T12:18:17.806Z"))
...
> = z.object({
  ...
  source: PostV2FeedbackEvaluationRequestBodyFeedbackSource$outboundSchema
    .default("orq"),
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-17T12:18:17.805Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-07-17T12:18:17.804Z"))
    .transform(v => v.toISOString()),
