...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2026-06-22T14:03:29.859Z"))
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-22T14:03:29.858Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  explanation: z.string().optional(),
  reviewedAt: z.date().default(() => new Date("2026-06-22T14:03:29.857Z"))
    .transform(v => v.toISOString()),
