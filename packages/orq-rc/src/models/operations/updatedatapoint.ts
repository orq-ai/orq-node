...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.131Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.130Z"))
    .transform(v => v.toISOString()),
