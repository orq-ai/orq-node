...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T08:19:31.062Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T08:19:31.061Z"))
    .transform(v => v.toISOString()),
