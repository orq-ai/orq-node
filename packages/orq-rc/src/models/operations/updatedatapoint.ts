...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T10:29:57.018Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T10:29:57.017Z"))
    .transform(v => v.toISOString()),
