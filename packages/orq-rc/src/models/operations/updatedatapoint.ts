...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T06:13:24.756Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T06:13:24.755Z"))
    .transform(v => v.toISOString()),
