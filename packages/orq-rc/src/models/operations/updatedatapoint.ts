...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-11T11:23:27.979Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-11T11:23:27.978Z"))
    .transform(v => v.toISOString()),
