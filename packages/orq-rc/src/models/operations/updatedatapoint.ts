...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T05:23:46.812Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T05:23:46.811Z"))
    .transform(v => v.toISOString()),
