...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T12:44:38.578Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T12:44:38.577Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T12:44:38.576Z"))
    .transform(v => v.toISOString()),
