...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-06T13:58:43.170Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-06T13:58:43.169Z"))
    .transform(v => v.toISOString()),
