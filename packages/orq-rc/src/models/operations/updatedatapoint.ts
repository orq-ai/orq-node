...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T09:22:00.089Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T09:22:00.088Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T09:22:00.087Z"))
    .transform(v => v.toISOString()),
