...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.131Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.130Z"))
    .transform(v => v.toISOString()),
