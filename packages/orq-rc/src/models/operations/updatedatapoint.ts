...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T09:05:00.277Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T09:05:00.276Z"))
    .transform(v => v.toISOString()),
