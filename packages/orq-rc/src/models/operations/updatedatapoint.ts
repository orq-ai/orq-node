...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.786Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.785Z"))
    .transform(v => v.toISOString()),
