...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-16T07:26:00.531Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-16T07:26:00.530Z"))
    .transform(v => v.toISOString()),
