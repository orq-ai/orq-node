...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T05:44:59.192Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T05:44:59.191Z"))
    .transform(v => v.toISOString()),
