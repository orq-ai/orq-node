...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T07:48:55.912Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T07:48:55.911Z"))
    .transform(v => v.toISOString()),
