...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T13:04:28.744Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T13:04:28.743Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T13:04:28.742Z"))
    .transform(v => v.toISOString()),
