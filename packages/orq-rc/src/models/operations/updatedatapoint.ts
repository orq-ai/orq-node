...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T08:38:11.493Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T08:38:11.492Z"))
    .transform(v => v.toISOString()),
