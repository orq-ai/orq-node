...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-22T21:11:58.505Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T21:11:58.504Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T21:11:58.503Z"))
    .transform(v => v.toISOString()),
