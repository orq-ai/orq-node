...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:42:55.764Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:42:55.763Z"))
    .transform(v => v.toISOString()),
