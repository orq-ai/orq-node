...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.160Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.159Z"))
    .transform(v => v.toISOString()),
