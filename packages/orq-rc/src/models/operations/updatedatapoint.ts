...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T14:28:52.050Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T14:28:52.049Z"))
    .transform(v => v.toISOString()),
