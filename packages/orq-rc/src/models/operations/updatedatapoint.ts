...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.808Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.807Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  updated: z.date().default(() => new Date("2025-10-29T04:55:50.891Z"))
    .transform(v => v.toISOString()),
}).transform((v) => {
  return remap$(v, {
    id: "_id",
