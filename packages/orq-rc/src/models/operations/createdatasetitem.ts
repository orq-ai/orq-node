...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T12:57:59.301Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T12:57:59.300Z"))
    .transform(v => v.toISOString()),
