...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-20T13:32:44.151Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-20T13:32:44.150Z"))
    .transform(v => v.toISOString()),
