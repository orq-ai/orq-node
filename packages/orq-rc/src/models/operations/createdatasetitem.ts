...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T13:19:57.137Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T13:19:57.136Z"))
    .transform(v => v.toISOString()),
