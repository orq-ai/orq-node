...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.952Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.951Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.950Z"))
    .transform(v => v.toISOString()),
