...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-10T04:39:50.168Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-10T04:39:50.167Z"))
    .transform(v => v.toISOString()),
