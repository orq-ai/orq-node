...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.654Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.653Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.652Z"))
    .transform(v => v.toISOString()),
