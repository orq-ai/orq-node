...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T13:30:34.693Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T13:30:34.692Z"))
    .transform(v => v.toISOString()),
