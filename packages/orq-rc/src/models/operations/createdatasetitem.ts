...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:03:20.994Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:03:20.993Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:03:20.992Z"))
    .transform(v => v.toISOString()),
