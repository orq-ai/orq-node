...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.987Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.986Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.985Z"))
    .transform(v => v.toISOString()),
