...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.035Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.034Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.033Z"))
    .transform(v => v.toISOString()),
