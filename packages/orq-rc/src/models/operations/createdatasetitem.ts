...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:21:16.900Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T09:21:16.899Z"))
    .transform(v => v.toISOString()),
