...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-11T07:16:34.101Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-11T07:16:34.100Z"))
    .transform(v => v.toISOString()),
