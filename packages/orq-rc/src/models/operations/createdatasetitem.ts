...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T06:27:19.264Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T06:27:19.256Z"))
    .transform(v => v.toISOString()),
