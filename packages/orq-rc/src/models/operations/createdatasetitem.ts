...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-27T14:02:23.035Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-27T14:02:23.034Z"))
    .transform(v => v.toISOString()),
