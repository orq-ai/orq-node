...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T09:28:37.837Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T09:28:37.836Z"))
    .transform(v => v.toISOString()),
