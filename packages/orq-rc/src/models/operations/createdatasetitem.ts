...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-08T03:27:12.333Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-08T03:27:12.332Z"))
    .transform(v => v.toISOString()),
