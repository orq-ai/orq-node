...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T12:11:34.791Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T12:11:34.790Z"))
    .transform(v => v.toISOString()),
