...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.871Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.870Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.869Z"))
    .transform(v => v.toISOString()),
