...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T13:28:03.021Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T13:28:03.020Z"))
    .transform(v => v.toISOString()),
