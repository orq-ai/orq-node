...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-08T07:01:39.193Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-08T07:01:39.192Z"))
    .transform(v => v.toISOString()),
