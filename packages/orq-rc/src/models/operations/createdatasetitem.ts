...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T09:18:56.143Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T09:18:56.142Z"))
    .transform(v => v.toISOString()),
