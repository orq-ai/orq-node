...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.726Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.725Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.717Z"))
    .transform(v => v.toISOString()),
