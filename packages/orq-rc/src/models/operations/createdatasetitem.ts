...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T11:15:59.633Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T11:15:59.632Z"))
    .transform(v => v.toISOString()),
