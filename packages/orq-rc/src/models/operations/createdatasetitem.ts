...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.091Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.090Z"))
    .transform(v => v.toISOString()),
