...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T11:09:20.954Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T11:09:20.953Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T11:09:20.952Z"))
    .transform(v => v.toISOString()),
