...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T07:11:09.611Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T07:11:09.610Z"))
    .transform(v => v.toISOString()),
