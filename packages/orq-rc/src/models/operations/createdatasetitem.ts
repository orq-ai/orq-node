...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.575Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.574Z"))
    .transform(v => v.toISOString()),
