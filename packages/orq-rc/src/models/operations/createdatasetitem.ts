...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.153Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.152Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.151Z"))
    .transform(v => v.toISOString()),
