...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.233Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.232Z"))
    .transform(v => v.toISOString()),
