...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T14:12:48.890Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T14:12:48.889Z"))
    .transform(v => v.toISOString()),
