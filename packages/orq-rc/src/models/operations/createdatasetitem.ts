...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.334Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.333Z"))
    .transform(v => v.toISOString()),
