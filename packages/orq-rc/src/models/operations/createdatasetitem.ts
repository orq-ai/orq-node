...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.965Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.964Z"))
    .transform(v => v.toISOString()),
