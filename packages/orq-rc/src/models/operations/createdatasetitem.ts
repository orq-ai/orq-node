...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T14:52:27.422Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T14:52:27.421Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T14:52:27.419Z"))
    .transform(v => v.toISOString()),
