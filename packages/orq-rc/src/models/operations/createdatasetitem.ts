...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T09:41:08.844Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T09:41:08.843Z"))
    .transform(v => v.toISOString()),
