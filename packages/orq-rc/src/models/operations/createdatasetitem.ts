...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.537Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.536Z"))
    .transform(v => v.toISOString()),
