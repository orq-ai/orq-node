...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-07T06:55:51.706Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-07T06:55:51.705Z"))
    .transform(v => v.toISOString()),
