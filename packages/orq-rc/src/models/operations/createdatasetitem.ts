...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-15T08:02:14.058Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-15T08:02:14.057Z"))
    .transform(v => v.toISOString()),
