...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.368Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.367Z"))
    .transform(v => v.toISOString()),
