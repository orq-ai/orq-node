...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T15:28:20.487Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T15:28:20.486Z"))
    .transform(v => v.toISOString()),
