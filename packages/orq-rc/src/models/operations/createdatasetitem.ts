...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.575Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.574Z"))
    .transform(v => v.toISOString()),
