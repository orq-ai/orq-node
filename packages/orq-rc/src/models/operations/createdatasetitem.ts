...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T11:28:58.142Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T11:28:58.141Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T11:28:58.140Z"))
    .transform(v => v.toISOString()),
