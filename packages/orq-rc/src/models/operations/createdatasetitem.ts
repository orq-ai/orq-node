...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T10:29:56.984Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T10:29:56.983Z"))
    .transform(v => v.toISOString()),
