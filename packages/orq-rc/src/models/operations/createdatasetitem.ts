...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T05:49:09.267Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T05:49:09.266Z"))
    .transform(v => v.toISOString()),
