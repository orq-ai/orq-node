...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T06:13:24.720Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T06:13:24.719Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T06:13:24.718Z"))
    .transform(v => v.toISOString()),
