...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-21T10:57:54.224Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-21T10:57:54.217Z"))
    .transform(v => v.toISOString()),
