...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-22T21:11:58.473Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T21:11:58.472Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T21:11:58.471Z"))
    .transform(v => v.toISOString()),
