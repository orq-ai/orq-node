...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-06T13:58:43.160Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-06T13:58:43.159Z"))
    .transform(v => v.toISOString()),
