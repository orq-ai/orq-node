...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T13:43:09.609Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T13:43:09.608Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T13:43:09.607Z"))
    .transform(v => v.toISOString()),
