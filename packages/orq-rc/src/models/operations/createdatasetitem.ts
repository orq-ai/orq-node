...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-14T11:49:09.841Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-14T11:49:09.840Z"))
    .transform(v => v.toISOString()),
