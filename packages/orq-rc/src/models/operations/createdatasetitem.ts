...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-28T05:15:02.793Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-28T05:15:02.792Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-28T05:15:02.791Z"))
    .transform(v => v.toISOString()),
