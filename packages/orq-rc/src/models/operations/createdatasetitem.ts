...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.467Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.466Z"))
    .transform(v => v.toISOString()),
