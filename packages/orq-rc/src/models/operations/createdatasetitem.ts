...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:42:55.734Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T08:42:55.733Z"))
    .transform(v => v.toISOString()),
