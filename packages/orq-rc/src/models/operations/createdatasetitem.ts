...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T15:03:29.072Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T15:03:29.071Z"))
    .transform(v => v.toISOString()),
