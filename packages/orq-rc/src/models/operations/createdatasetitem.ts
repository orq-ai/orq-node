...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T15:06:57.377Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T15:06:57.376Z"))
    .transform(v => v.toISOString()),
