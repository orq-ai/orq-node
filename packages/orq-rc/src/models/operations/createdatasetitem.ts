...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-23T13:46:21.435Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-23T13:46:21.434Z"))
    .transform(v => v.toISOString()),
