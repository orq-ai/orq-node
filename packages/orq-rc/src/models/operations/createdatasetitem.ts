...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T09:59:24.127Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T09:59:24.126Z"))
    .transform(v => v.toISOString()),
