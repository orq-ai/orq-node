...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T11:13:53.971Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T11:13:53.970Z"))
    .transform(v => v.toISOString()),
