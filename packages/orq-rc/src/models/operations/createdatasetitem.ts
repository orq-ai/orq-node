...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.788Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.787Z"))
    .transform(v => v.toISOString()),
