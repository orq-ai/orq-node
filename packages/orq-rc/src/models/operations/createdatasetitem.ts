...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.088Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.087Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:42:02.086Z"))
    .transform(v => v.toISOString()),
