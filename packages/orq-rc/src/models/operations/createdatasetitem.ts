...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T07:50:27.184Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T07:50:27.183Z"))
    .transform(v => v.toISOString()),
