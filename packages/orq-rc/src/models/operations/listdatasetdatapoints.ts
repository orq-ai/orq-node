...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.302Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T11:29:46.301Z"))
    .transform(v => v.toISOString()),
