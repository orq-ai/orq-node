...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.209Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.208Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T19:31:38.207Z"))
    .transform(v => v.toISOString()),
