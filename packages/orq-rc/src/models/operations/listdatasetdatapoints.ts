...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-28T05:15:02.777Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-28T05:15:02.776Z"))
    .transform(v => v.toISOString()),
