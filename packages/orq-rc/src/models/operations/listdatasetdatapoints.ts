...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-03T13:43:09.593Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-03T13:43:09.592Z"))
    .transform(v => v.toISOString()),
