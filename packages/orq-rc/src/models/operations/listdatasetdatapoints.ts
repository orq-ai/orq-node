...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.340Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.339Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T10:15:20.338Z"))
    .transform(v => v.toISOString()),
