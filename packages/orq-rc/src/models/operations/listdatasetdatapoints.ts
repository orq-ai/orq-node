...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T15:28:20.474Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T15:28:20.473Z"))
    .transform(v => v.toISOString()),
