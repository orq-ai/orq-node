...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-08T07:01:39.188Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-08T07:01:39.187Z"))
    .transform(v => v.toISOString()),
