...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T09:05:00.220Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T09:05:00.219Z"))
    .transform(v => v.toISOString()),
