...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T04:24:17.592Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T04:24:17.591Z"))
    .transform(v => v.toISOString()),
