...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.014Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T12:02:46.013Z"))
    .transform(v => v.toISOString()),
