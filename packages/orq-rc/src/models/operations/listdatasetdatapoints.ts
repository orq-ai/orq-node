...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T05:23:46.761Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T05:23:46.760Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T05:23:46.759Z"))
    .transform(v => v.toISOString()),
