...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T13:30:34.652Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T13:30:34.651Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T13:30:34.650Z"))
    .transform(v => v.toISOString()),
