...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T07:47:16.798Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T07:47:16.797Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T07:47:16.788Z"))
    .transform(v => v.toISOString()),
