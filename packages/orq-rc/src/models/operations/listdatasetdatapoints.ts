...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-10T11:07:58.025Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-10T11:07:58.024Z"))
    .transform(v => v.toISOString()),
