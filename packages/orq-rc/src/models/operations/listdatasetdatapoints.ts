...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.942Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-22T10:49:34.941Z"))
    .transform(v => v.toISOString()),
