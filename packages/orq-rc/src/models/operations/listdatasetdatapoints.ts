...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-10T04:39:50.154Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-10T04:39:50.153Z"))
    .transform(v => v.toISOString()),
