...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T07:48:55.852Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T07:48:55.851Z"))
    .transform(v => v.toISOString()),
