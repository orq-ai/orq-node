...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-25T04:58:57.090Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-25T04:58:57.089Z"))
    .transform(v => v.toISOString()),
