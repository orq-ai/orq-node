...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-24T09:48:43.404Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-24T09:48:43.403Z"))
    .transform(v => v.toISOString()),
