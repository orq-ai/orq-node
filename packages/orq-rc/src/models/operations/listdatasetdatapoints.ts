...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:39:41.824Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T14:39:41.823Z"))
    .transform(v => v.toISOString()),
