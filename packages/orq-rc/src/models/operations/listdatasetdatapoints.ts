...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.437Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.436Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T10:50:12.435Z"))
    .transform(v => v.toISOString()),
