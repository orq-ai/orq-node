...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-04T13:28:02.991Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T13:28:02.989Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-04T13:28:02.988Z"))
    .transform(v => v.toISOString()),
