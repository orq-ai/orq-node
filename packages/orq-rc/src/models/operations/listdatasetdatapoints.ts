...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-08T14:08:13.529Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-08T14:08:13.528Z"))
    .transform(v => v.toISOString()),
