...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-11T05:06:32.219Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-11T05:06:32.218Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-11T05:06:32.217Z"))
    .transform(v => v.toISOString()),
