...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T08:19:31.012Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T08:19:31.011Z"))
    .transform(v => v.toISOString()),
