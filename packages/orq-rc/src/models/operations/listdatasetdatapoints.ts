...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.102Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T11:17:39.101Z"))
    .transform(v => v.toISOString()),
