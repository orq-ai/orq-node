...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.511Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T09:11:50.510Z"))
    .transform(v => v.toISOString()),
