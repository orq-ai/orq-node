...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-12T11:48:23.414Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-12T11:48:23.413Z"))
    .transform(v => v.toISOString()),
