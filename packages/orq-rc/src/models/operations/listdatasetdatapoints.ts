...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T08:38:11.441Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T08:38:11.440Z"))
    .transform(v => v.toISOString()),
