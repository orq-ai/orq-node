...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T06:52:50.403Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T06:52:50.402Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T06:52:50.401Z"))
    .transform(v => v.toISOString()),
