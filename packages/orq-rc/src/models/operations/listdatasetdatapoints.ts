...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.743Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.742Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T04:56:03.741Z"))
    .transform(v => v.toISOString()),
