...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.699Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T09:35:04.698Z"))
    .transform(v => v.toISOString()),
