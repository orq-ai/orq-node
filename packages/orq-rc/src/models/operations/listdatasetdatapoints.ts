...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-20T09:56:50.011Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-20T09:56:50.010Z"))
    .transform(v => v.toISOString()),
