...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-08T21:45:02.611Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-08T21:45:02.610Z"))
    .transform(v => v.toISOString()),
