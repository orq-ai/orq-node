...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-24T12:43:31.771Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-24T12:43:31.770Z"))
    .transform(v => v.toISOString()),
