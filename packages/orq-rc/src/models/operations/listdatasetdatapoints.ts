...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T05:25:06.670Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T05:25:06.669Z"))
    .transform(v => v.toISOString()),
