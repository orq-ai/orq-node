...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T13:19:57.118Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T13:19:57.117Z"))
    .transform(v => v.toISOString()),
