...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-15T05:20:16.793Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-15T05:20:16.786Z"))
    .transform(v => v.toISOString()),
