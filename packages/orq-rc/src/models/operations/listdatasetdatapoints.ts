...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T12:57:59.276Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T12:57:59.275Z"))
    .transform(v => v.toISOString()),
