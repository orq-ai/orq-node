...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.735Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.734Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T05:37:59.733Z"))
    .transform(v => v.toISOString()),
