...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T09:18:56.110Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T09:18:56.109Z"))
    .transform(v => v.toISOString()),
