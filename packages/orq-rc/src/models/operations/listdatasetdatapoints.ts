...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T07:33:30.317Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T07:33:30.316Z"))
    .transform(v => v.toISOString()),
