...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.132Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-26T16:26:34.130Z"))
    .transform(v => v.toISOString()),
