...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:08:29.271Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-13T11:08:29.270Z"))
    .transform(v => v.toISOString()),
