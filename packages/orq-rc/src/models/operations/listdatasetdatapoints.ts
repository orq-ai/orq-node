...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-06T05:49:09.233Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-06T05:49:09.232Z"))
    .transform(v => v.toISOString()),
