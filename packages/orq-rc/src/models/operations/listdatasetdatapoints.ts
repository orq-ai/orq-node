...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.923Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-10T05:21:48.922Z"))
    .transform(v => v.toISOString()),
