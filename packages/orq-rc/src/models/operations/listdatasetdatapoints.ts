...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.553Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T04:59:26.552Z"))
    .transform(v => v.toISOString()),
