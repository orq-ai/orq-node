...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.069Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.068Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-28T15:44:20.067Z"))
    .transform(v => v.toISOString()),
