...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-30T04:37:57.903Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T04:37:57.902Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-30T04:37:57.901Z"))
    .transform(v => v.toISOString()),
