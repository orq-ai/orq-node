...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-14T05:44:59.126Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-14T05:44:59.125Z"))
    .transform(v => v.toISOString()),
