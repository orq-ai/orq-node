...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-20T13:32:44.147Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-20T13:32:44.146Z"))
    .transform(v => v.toISOString()),
