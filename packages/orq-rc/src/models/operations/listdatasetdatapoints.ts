...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-19T10:42:46.780Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-19T10:42:46.779Z"))
    .transform(v => v.toISOString()),
