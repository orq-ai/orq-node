...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-16T10:40:29.524Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-16T10:40:29.523Z"))
    .transform(v => v.toISOString()),
