...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.639Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-24T13:35:12.638Z"))
    .transform(v => v.toISOString()),
