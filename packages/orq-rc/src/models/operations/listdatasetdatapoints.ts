...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.949Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-07T12:12:18.948Z"))
    .transform(v => v.toISOString()),
