...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-05T15:06:57.348Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-05T15:06:57.343Z"))
    .transform(v => v.toISOString()),
