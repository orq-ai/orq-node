...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-17T17:33:44.502Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T17:33:44.501Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-17T17:33:44.494Z"))
    .transform(v => v.toISOString()),
