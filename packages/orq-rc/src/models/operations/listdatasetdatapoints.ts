...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:22:51.949Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-12T13:22:51.948Z"))
    .transform(v => v.toISOString()),
