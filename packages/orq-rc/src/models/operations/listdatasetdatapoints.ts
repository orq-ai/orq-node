...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-20T05:21:54.975Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-20T05:21:54.974Z"))
    .transform(v => v.toISOString()),
