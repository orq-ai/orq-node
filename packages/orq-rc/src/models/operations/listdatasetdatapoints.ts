...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.550Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.549Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T08:59:57.548Z"))
    .transform(v => v.toISOString()),
