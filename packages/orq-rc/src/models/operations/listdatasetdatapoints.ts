...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-14T11:49:09.834Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-14T11:49:09.833Z"))
    .transform(v => v.toISOString()),
