...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T15:03:29.061Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T15:03:29.060Z"))
    .transform(v => v.toISOString()),
