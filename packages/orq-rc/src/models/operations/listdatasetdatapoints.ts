...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-20T14:28:51.996Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-20T14:28:51.995Z"))
    .transform(v => v.toISOString()),
