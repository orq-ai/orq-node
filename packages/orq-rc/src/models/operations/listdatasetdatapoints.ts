...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-21T10:28:50.418Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-21T10:28:50.417Z"))
    .transform(v => v.toISOString()),
