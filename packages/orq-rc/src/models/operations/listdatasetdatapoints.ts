...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-27T11:28:58.108Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T11:28:58.107Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-27T11:28:58.106Z"))
    .transform(v => v.toISOString()),
