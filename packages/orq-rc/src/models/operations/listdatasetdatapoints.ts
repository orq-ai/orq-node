...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-23T06:53:51.011Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-23T06:53:51.010Z"))
    .transform(v => v.toISOString()),
