...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-21T08:05:52.831Z"))
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-21T08:05:52.830Z"))
    .transform(v => v.toISOString()),
