...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.769Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.768Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-10-29T09:19:36.767Z"))
    .transform(v => v.toISOString()),
