...
> = z.object({
  ...
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.798Z"))
...
> = z.object({
  ...
  source: ListDatasetDatapointsEvaluationsDatasetsResponseSource$outboundSchema
    .default("orq"),
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.797Z"))
    .transform(v => v.toISOString()),
...
> = z.object({
  ...
  reviewedById: z.string(),
  reviewedAt: z.date().default(() => new Date("2025-11-18T00:47:33.793Z"))
    .transform(v => v.toISOString()),
